...
1.7.0 cycle (latest beta: 1.7.0-beta.2). Headlined by a heap-fragmentation crash fix for long-running devices, with the root cause traced to HTTP request serving in beta.2.
