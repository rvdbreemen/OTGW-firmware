...
After years of development and extensive community testing, we're thrilled to announce **OTGW-firmware version 1.0.0** — the first production-ready release of the ESP8266 firmware for the NodoShop OpenTherm Gateway!
...
Version 1.0.0 is built on the foundation of extensive testing through multiple release candidates (RC1-RC4), with critical stability improvements, security hardening, and memory optimizations that make it significantly more robust than the 0.10.x series.
