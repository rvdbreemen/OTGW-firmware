...
|-|-|
| 0.8.7 | Compile with espcore 3.0.2 (lowlevel core update)<br>Improved wifi reconnection logic (reboot if 15min not connected)<br>Added NTP hostname setting in webUI|
