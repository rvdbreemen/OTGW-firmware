...
## Version 1.0.0-rc3 - Current Beta Release Candidate
This development branch currently tracks **version 1.0.0-rc3**, the latest beta release candidate ahead of the stable 1.0.0 release available on the main branch.

This RC represents a major "moment in time" for the project. After years of development and testing, the REST API and MQTT interface have proven their stability and reliability. The RC embodies the original vision for the firmware, bringing polished features like:
...
This RC also includes **many small stability improvements** once more, to make the beta even more robust than the 0.10.x series already was.
...
The main branch reflects the latest stable release, while this branch summarizes the current 1.0.0-rc3 beta.
