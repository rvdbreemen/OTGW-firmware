...
|-|-|
| 0.7.6 | PIC firmware integration done. <br> NTP configurable <br> Web UI only values that have been updated <br> Update to REST API to include epoch of last update to message <br> cleanup of web UI a bit|
