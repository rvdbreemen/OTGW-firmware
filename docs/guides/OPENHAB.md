...
| Stale Things after a topic-shape change | Clear zombie/orphan retained configs as documented in [`docs/api/MQTT.md` — Migration note (zombie discovery configs from beta.21, ADR-071)](../api/MQTT.md#migration-note-zombie-discovery-configs-from-beta21-adr-071), then republish. |
