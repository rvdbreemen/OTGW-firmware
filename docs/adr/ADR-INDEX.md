...
| ADR-097 | Proposed | `src/OTGW-firmware/OTGW-Core.ino` | Chosen option: Option D, because it is the only option that lets two command-sending tools share the port while keepi... |
