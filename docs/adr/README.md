...
| ADR-019 | REST API Versioning Strategy | Accepted | 2020-06-01 | - | ADR-019-rest-api-versioning-strategy.md |
...
| ADR-096 | Serve one REST API version at a time and remove superseded ones | Proposed | 2026-09-18 | Supersedes ADR-019 | ADR-096-serve-one-rest-api-version-at-a-time-and-remove-superseded-ones.md |
<!-- adr-kit-index:end -->
