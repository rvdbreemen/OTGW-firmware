...
- **[ADR-085: Unified Off/Heat/Cool HA Climate Entity Derived from OpenTherm Status Bits](ADR-085-ha-climate-heat-cool-from-ot-status-bits.md)** *(Accepted)*
  Replaces the heating-only HA Thermostat entity with a unified off/heat/cool climate entity driven by two firmware-computed topics (`<pub>/hvac_mode`, `<pub>/hvac_action`) derived from the MsgID 0 status bits. Mode is reflective (no `mode_command_topic`; the thermostat owns heat/cool switching); heating reads the central-heating slave bit, not flame, so DHW does not show as heating. Fixes GH #665 (cooling invisible on a heatpump). Mirror of ADR-156 on the 2.0.0 line.
...
| --- | --- | --- | --- | --- | --- |
| ADR-001 | ESP8266 Platform Selection | Accepted | 2016-01-01 | - | ADR-001-esp8266-platform-selection.md |
| ADR-002 | Modular .ino File Architecture | Accepted | 2018-06-01 | - | ADR-002-modular-ino-architecture.md |
| ADR-003 | HTTP-Only Network Architecture (No HTTPS) | Accepted | 2018-01-01 | - | ADR-003-http-only-no-https.md |
| ADR-004 | Static Buffer Allocation Strategy | Superseded | 2020-01-01 | Superseded by ADR-053 | ADR-004-static-buffer-allocation.md |
| ADR-005 | WebSocket for Real-Time Streaming | Accepted | 2019-06-01 | - | ADR-005-websocket-real-time-streaming.md |
| ADR-006 | MQTT Integration Pattern | Accepted | 2018-06-01 | - | ADR-006-mqtt-integration-pattern.md |
| ADR-007 | Timer-Based Task Scheduling | Accepted | 2018-06-01 | - | ADR-007-timer-based-task-scheduling.md |
| ADR-008 | LittleFS for Configuration Persistence | Accepted | 2020-06-01 | - | ADR-008-littlefs-configuration-persistence.md |
| ADR-009 | PROGMEM Usage for String Literals | Accepted | 2018-06-01 | - | ADR-009-progmem-string-literals.md |
| ADR-010 | Multiple Concurrent Network Services | Accepted | 2019-01-01 | - | ADR-010-multiple-concurrent-network-services.md |
| ADR-011 | External Hardware Watchdog for Reliability | Accepted | 2018-01-01 | - | ADR-011-external-hardware-watchdog.md |
| ADR-012 | PIC Firmware Upgrade via Web UI | Accepted | 2019-06-01 | - | ADR-012-pic-firmware-upgrade-via-web.md |
| ADR-013 | Arduino Framework Over ESP-IDF | Accepted | 2016-01-01 | - | ADR-013-arduino-framework-over-esp-idf.md |
| ADR-014 | Dual Build System (Makefile + Python Script) | Accepted | 2020-01-01 | - | ADR-014-dual-build-system.md |
| ADR-015 | NTP and AceTime for Time Management | Accepted | 2021-10-16 | - | ADR-015-ntp-acetime-time-management.md |
| ADR-016 | OpenTherm Command Queue with Deduplication | Accepted | 2018-06-01 | - | ADR-016-opentherm-command-queue.md |
| ADR-017 | WiFiManager for Initial Configuration | Accepted | 2018-01-01 | - | ADR-017-wifimanager-initial-configuration.md |
| ADR-018 | ArduinoJson for Data Interchange | Superseded | 2018-01-01 | Superseded by ADR-042 | ADR-018-arduinojson-data-interchange.md |
| ADR-019 | REST API Versioning Strategy | Superseded | 2026-09-18 | Superseded by ADR-096 | ADR-019-rest-api-versioning-strategy.md |
| ADR-020 | Dallas DS18B20 Temperature Sensor Integration | Accepted | 2019-01-01 | - | ADR-020-dallas-ds18b20-sensor-integration.md |
| ADR-021 | S0 Pulse Counter Hardware Interrupt Architecture | Accepted | 2020-01-01 | - | ADR-021-s0-pulse-counter-interrupt-architecture.md |
| ADR-022 | GPIO Output Control (Bit-Flag Triggered Relays) | Accepted | 2020-06-01 | - | ADR-022-gpio-output-bit-flag-control.md |
| ADR-023 | File System Explorer HTTP Architecture | Accepted | 2019-01-01 | - | ADR-023-filesystem-explorer-http-api.md |
| ADR-024 | Debug Telnet Command Console | Accepted | 2018-06-01 | - | ADR-024-debug-telnet-command-console.md |
| ADR-025 | Safari WebSocket Connection Management During Firmware Upload | Accepted | 2026-01-29 | - | ADR-025-safari-websocket-connection-management.md |
| ADR-026 | Conditional JavaScript Cache-Busting for Firmware/Filesystem Version Mismatches | Accepted | 2026-01-31 | - | ADR-026-conditional-javascript-cache-busting.md |
| ADR-027 | Version Mismatch Warning System in Web UI | Accepted | 2026-01-31 | - | ADR-027-version-mismatch-warning-system.md |
| ADR-028 | File Streaming Over Loading for Memory Safety | Accepted | 2026-02-01 | - | ADR-028-file-streaming-over-loading.md |
| ADR-029 | Simple XHR-Based OTA Flash (KISS Principle) | Accepted | 2026-02-04 | - | ADR-029-simple-xhr-ota-flash.md |
| ADR-030 | Heap Memory Monitoring and Emergency Recovery | Accepted | 2026-02-07 | - | ADR-030-heap-memory-monitoring-emergency-recovery.md |
| ADR-031 | Two-Microcontroller Coordination Architecture | Accepted | 2026-02-07 | - | ADR-031-two-microcontroller-coordination-architecture.md |
| ADR-032 | No Authentication Pattern (Local Network Security Model) | Accepted | 2026-02-07 | - | ADR-032-no-authentication-local-network-security.md |
| ADR-033 | Dallas Sensor Custom Labels and Graph Visualization | Accepted | 2026-02-07 | - | ADR-033-dallas-sensor-custom-labels-graph-visualization.md |
| ADR-034 | Non-Blocking Modal Dialogs for User Input | Accepted | 2026-02-04 | - | ADR-034-non-blocking-modal-dialogs.md |
| ADR-035 | RESTful API Compliance Strategy | Accepted | 2026-02-16 | - | ADR-035-restful-api-compliance-strategy.md |
| ADR-036 | Boot Sequence Initialization Ordering | Accepted | 2026-02-16 | - | ADR-036-boot-sequence-ordering.md |
| ADR-037 | Gateway Mode Detection via PR=M Polling | Accepted | 2026-02-16 | - | ADR-037-gateway-mode-detection.md |
| ADR-038 | OpenTherm Message Data Flow Pipeline | Superseded | 2026-09-03 | Superseded by ADR-095 | ADR-038-opentherm-data-flow-pipeline.md |
| ADR-039 | Real-Time OTGraph Charting Architecture | Accepted | 2026-02-16 | - | ADR-039-otgraph-real-time-charting.md |
| ADR-040 | MQTT Source-Specific Topics for OpenTherm Values | Accepted | 2026-02-16 | - | ADR-040-mqtt-source-specific-topics.md |
| ADR-041 | Just-In-Time Home Assistant MQTT Discovery | Superseded | 2026-05-08 | Superseded by ADR-073 | ADR-041-jit-ha-discovery.md |
| ADR-042 | Streaming JSON I/O — No ArduinoJson | Accepted | 2026-02-28 | Supersedes ADR-018 | ADR-042-streaming-json-no-arduinojson.md |
| ADR-043 | Reset-Pattern WiFi Recovery Trigger | Accepted | 2026-03-01 | - | ADR-043-reset-pattern-wifi-recovery.md |
| ADR-044 | Global State — extern Declaration in Header, Definition in .ino | Accepted | 2026-03-05 | - | ADR-044-global-state-header-definition-pattern.md |
| ADR-045 | PS=1 Print Summary Parsing | Superseded | 2026-03-02 | Superseded by ADR-046 | ADR-045-ps1-print-summary-parsing.md |
| ADR-046 | PS=1 Summary Translation with Shared Publish Helpers | Accepted | 2026-03-07 | Supersedes ADR-045 | ADR-046-ps1-summary-translation-shared-publish-helpers.md |
| ADR-047 | Non-Blocking WiFi Reconnect State Machine | Superseded | 2026-03-01 | Superseded by ADR-061 | ADR-047-nonblocking-wifi-reconnect.md |
| ADR-048 | Non-Blocking Webhook State Machine with Retry | Accepted | 2026-03-01 | - | ADR-048-nonblocking-webhook-state-machine.md |
| ADR-049 | String Class Prohibition in Protocol Paths | Accepted | 2026-03-01 | - | ADR-049-string-prohibition-protocol-paths.md |
| ADR-050 | Centralized API Route Dispatch Table | Accepted | 2026-03-01 | - | ADR-050-centralized-api-route-dispatch.md |
| ADR-051 | Dual Encapsulating Structs (Settings + State) | Accepted | 2026-03-01 | - | ADR-051-dual-encapsulating-structs.md |
| ADR-052 | MQTT Publish Eligibility and Reconnect Refresh Contract | Accepted | 2026-03-17 | - | ADR-052-mqtt-publish-eligibility-contract.md |
| ADR-053 | Large Feature Buffer Static Allocation | Accepted | 2026-03-21 | Supersedes ADR-004 | ADR-053-large-feature-buffer-static-allocation.md |
| ADR-054 | Optional HTTP Basic Authentication for Settings | Superseded | 2026-02-24 | Superseded by ADR-056 | ADR-054-optional-http-basic-auth.md |
| ADR-055 | Webhook Outbound HTTP Integration | Superseded | 2026-03-02 | Superseded by ADR-057 | ADR-055-webhook-outbound-http-integration.md |
| ADR-056 | Protected Admin Endpoint Security and Secret-Handling Contract | Accepted | 2026-03-21 | Supersedes ADR-054 | ADR-056-protected-admin-endpoint-security-and-secret-handling-contract.md |
| ADR-057 | Webhook Delivery, Retry, and Protected Test Endpoint Policy | Accepted | 2026-03-21 | Supersedes ADR-055 | ADR-057-webhook-delivery-retry-and-protected-test-endpoint-policy.md |
| ADR-058 | Non-blocking PIC Command/Response for PR= Queries | Accepted | 2026-03-27 | - | ADR-058-nonblocking-pic-command-response.md |
| ADR-059 | Ser2net Queue Awareness and Serial Bus Coordination | Accepted | 2026-03-28 | - | ADR-059-ser2net-queue-awareness.md |
| ADR-060 | PIC Availability Guard Pattern | Accepted | 2026-03-31 | - | ADR-060-pic-availability-guard-pattern.md |
| ADR-061 | WiFi Reconnect Timeout Tuning | Accepted | 2026-04-03 | Supersedes ADR-047 | ADR-061-wifi-reconnect-timeout-tuning.md |
| ADR-062 | — Retained discovery verification via wildcard subscribe with RAM-tuned buffer resize | Superseded | 2026-07-22 | Superseded by ADR-087 | ADR-062-retained-discovery-verification.md |
| ADR-064 | — Time-boundary consume-on-read helpers MUST have exactly one call site | Accepted | 2026-04-20 | - | ADR-064-time-boundary-single-caller-contract.md |
| ADR-065 | — otgw-pic/ MQTT subtree as stable public topic API | Accepted | 2026-04-23 | - | ADR-065-otgw-pic-mqtt-subtree.md |
| ADR-066 | MQTT Publish Gating by Source and Per-MsgID Slave-Echo Classification | Proposed | 2026-04-28 | - | ADR-066-mqtt-publish-gating-by-source-and-slave-echo.md |
| ADR-067 | — HA Discovery State Reconciliation on OTA Upgrade | Deprecated | 2026-05-04 | - | ADR-067-ha-discovery-state-reconciliation-on-ota-upgrade.md |
| ADR-068 | bSeparateSources Makes Base and Source-Variant Entities Mutually Exclusive | Superseded | 2026-05-07 | Superseded by ADR-070 | ADR-068-bseparatesources-mutually-exclusive-base-and-source-variants.md |
| ADR-069 | MQTT Source-Subtopic Worldview Semantics | Superseded | 2026-05-19 | Superseded by ADR-075 | ADR-069-mqtt-source-topic-worldview-semantics.md |
| ADR-070 | MQTT Source-Topic Sibling-Suffix Shape | Superseded | 2026-05-07 | Superseded by ADR-071; Supersedes ADR-068 | ADR-070-mqtt-source-topic-sibling-suffix-shape.md |
| ADR-071 | MQTT Discovery Topic Sibling-Suffix Shape (Supersedes ADR-070) | Accepted | 2026-05-07 | Supersedes ADR-070 | ADR-071-mqtt-discovery-topic-sibling-suffix-shape.md |
| ADR-072 | — HA Discovery Friendly-Name Format | Accepted | - | - | ADR-072-ha-discovery-friendly-name-format.md |
| ADR-073 | JIT HA Discovery with Smart Reconnect (Supersedes ADR-041) | Superseded | 2026-08-07 | Superseded by ADR-088; Supersedes ADR-041 | ADR-073-jit-ha-discovery-smart-reconnect.md |
| ADR-074 | HA Entity Availability Reflects the MQTT Link, Not OpenTherm-Bus Liveness | Accepted | 2026-05-16 | - | ADR-074-ha-availability-reflects-mqtt-link-not-ot-bus.md |
| ADR-075 | MQTT Source-Topic Worldview Routing — Proxy-Answer (no-B) Refinement | Accepted | 2026-05-19 | Supersedes ADR-069 | ADR-075-mqtt-source-topic-proxy-answer-routing.md |
| ADR-076 | MQTT Status Fan-Out — Drop Global Rate-Gate, Keep Per-Slot Heartbeat | Accepted | 2026-05-21 | - | ADR-076-mqtt-status-fanout-drop-global-rate-gate.md |
| ADR-077 | MQTT — Publish HA-Core-Style Self-Describing Aliases for Capability, State, Type, and Fault Bits under `settings.mqtt.bPublishHaCoreAliases` | Superseded | 2026-05-21 | Superseded by ADR-078 | ADR-077-mqtt-ha-core-capability-flag-aliases.md |
| ADR-078 | Defer HA-Core Capability-Flag Aliases — Ship on 2.0.0 Only, Revert from `dev` | Accepted | 2026-05-21 | Supersedes ADR-077 | ADR-078-defer-ha-core-aliases-to-2-0-0-revert-from-dev.md |
| ADR-079 | Emergency Heap Recovery Actions | Accepted | 2026-05-23 | - | ADR-079-emergency-heap-recovery-actions.md |
| ADR-080 | MQTT connect() socket timeout accepted as known main-loop sync-blocker | Accepted | 2026-05-23 | - | ADR-080-mqtt-connect-socket-timeout-as-accepted-sync-blocker.md |
| ADR-081 | MQTT on-change publishing as the default with one-time interval migration | Accepted | 2026-05-31 | - | ADR-081-mqtt-on-change-publishing-default.md |
| ADR-082 | Surface gateway overrides as distinct override state | Accepted | 2026-06-01 | - | ADR-082-surface-gateway-overrides-as-distinct-override-state.md |
| ADR-083 | Per-Consumer Heap Gating (WebSocket vs MQTT decoupling) | Proposed | - | - | ADR-083-per-consumer-heap-gating.md |
| ADR-084 | Build-Time ESP8266 Core Patch for the HTTP NULL-Alloc Crash | Rejected | 2026-06-10 | - | ADR-084-build-time-core-patch-http-null-alloc.md |
| ADR-085 | Unified Off/Heat/Cool Home Assistant Climate Entity Derived from OpenTherm Status Bits | Accepted | 2026-06-27 | - | ADR-085-ha-climate-heat-cool-from-ot-status-bits.md |
| ADR-086 | Rate-Limit the UI-Polled REST Endpoints with RFC 9457 429 Responses | Accepted | 2026-07-20 | - | ADR-086-rate-limit-ui-polled-rest-endpoints.md |
| ADR-087 | Unconditional daily drip republish replaces automatic discovery-verify readback | Accepted | 2026-07-22 | Supersedes ADR-062 | ADR-087-daily-drip-republish-replaces-discovery-verify-readback.md |
| ADR-088 | Republish on-change gated MQTT state when Home Assistant comes back online | Accepted | 2026-08-07 | Supersedes ADR-073 | ADR-088-republish-on-change-gated-mqtt-state-when-home-assistant-comes-back-online.md |
| ADR-089 | Judge ADRs declaratively per commit and semantically once a week | Accepted | 2026-08-25 | - | ADR-089-judge-adrs-declaratively-per-commit-and-semantically-once-a-week.md |
| ADR-090 | Publish a firmware-integrated cumulative DHW water total for the Home Assistant Energy dashboard | Superseded | 2026-08-26 | Superseded by ADR-093 | ADR-090-publish-a-firmware-integrated-cumulative-dhw-water-total-for-the-home-assistant-energy-dashboard.md |
| ADR-091 | A heap refusal must not suppress the cleanup path it depends on | Accepted | 2026-08-25 | - | ADR-091-a-heap-refusal-must-not-suppress-the-cleanup-path-it-depends-on.md |
| ADR-092 | Keep a recovery route reachable when the HTTP heap gate refuses | Accepted | 2026-08-25 | - | ADR-092-keep-a-recovery-route-reachable-when-the-http-heap-gate-refuses.md |
| ADR-093 | Keep the cumulative DHW water total in RAM and announce it on first data | Superseded | 2026-08-27 | Superseded by ADR-094; Supersedes ADR-090 | ADR-093-keep-the-cumulative-dhw-water-total-in-ram-and-announce-it-on-first-data.md |
| ADR-094 | Correct the DHW water total record: announce gating, live citations and measured costs | Accepted | 2026-08-27 | Supersedes ADR-093 | ADR-094-correct-the-dhw-water-total-record-announce-gating-live-citations-and-measured-costs.md |
| ADR-095 | OpenTherm data flow pipeline with an enforced byte-transparent serial bridge | Accepted | 2026-09-03 | Supersedes ADR-038 | ADR-095-opentherm-data-flow-pipeline-with-an-enforced-byte-transparent-serial-bridge.md |
| ADR-096 | Serve one REST API version at a time and remove superseded ones | Accepted | 2026-09-18 | Supersedes ADR-019 | ADR-096-serve-one-rest-api-version-at-a-time-and-remove-superseded-ones.md |
| ADR-097 | Allow two writers on port 25238 by forwarding each command line to the PIC whole | Proposed | 2026-09-26 | - | ADR-097-allow-two-writers-on-port-25238-by-forwarding-each-command-line-to-the-pic-whole.md |
<!-- adr-kit-index:end -->
