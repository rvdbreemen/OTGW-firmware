...
- **[ADR-142: HA Discovery — Mark Unsupported MsgID Entities Unavailable via Availability List](ADR-142-ha-discovery-mark-unavailable-unsupported-msgids.md)** 🆕 *(Deferred to 2.1.0)*  
...
| --- | --- | --- | --- | --- | --- |
| ADR-001 | ESP8266 Platform Selection | Superseded | - | Superseded by ADR-061 | ADR-001-esp8266-platform-selection.md |
| ADR-002 | Modular .ino File Architecture | Accepted | - | - | ADR-002-modular-ino-architecture.md |
| ADR-003 | HTTP-Only Network Architecture (No HTTPS) | Accepted | - | - | ADR-003-http-only-no-https.md |
| ADR-004 | Static Buffer Allocation Strategy | Superseded | - | Superseded by ADR-053 | ADR-004-static-buffer-allocation.md |
| ADR-005 | WebSocket for Real-Time Streaming | Superseded | - | Superseded by ADR-133 | ADR-005-websocket-real-time-streaming.md |
| ADR-006 | MQTT Integration Pattern | Accepted | - | - | ADR-006-mqtt-integration-pattern.md |
| ADR-007 | Timer-Based Task Scheduling | Accepted | - | - | ADR-007-timer-based-task-scheduling.md |
| ADR-008 | LittleFS for Configuration Persistence | Accepted | - | - | ADR-008-littlefs-configuration-persistence.md |
| ADR-009 | PROGMEM Usage for String Literals | Accepted | - | - | ADR-009-progmem-string-literals.md |
| ADR-010 | Multiple Concurrent Network Services | Accepted | - | - | ADR-010-multiple-concurrent-network-services.md |
| ADR-011 | External Hardware Watchdog for Reliability | Amended | - | - | ADR-011-external-hardware-watchdog.md |
| ADR-012 | PIC Firmware Upgrade via Web UI | Accepted | - | - | ADR-012-pic-firmware-upgrade-via-web.md |
| ADR-013 | Arduino Framework Over ESP-IDF | Accepted | - | - | ADR-013-arduino-framework-over-esp-idf.md |
| ADR-014 | Dual Build System (Makefile + Python Script) | Superseded | - | Superseded by ADR-083 | ADR-014-dual-build-system.md |
| ADR-015 | NTP and AceTime for Time Management | Accepted | - | - | ADR-015-ntp-acetime-time-management.md |
| ADR-016 | OpenTherm Command Queue with Deduplication | Accepted | - | - | ADR-016-opentherm-command-queue.md |
| ADR-017 | WiFiManager for Initial Configuration | Accepted | - | - | ADR-017-wifimanager-initial-configuration.md |
| ADR-018 | ArduinoJson for Data Interchange | Superseded | - | Superseded by ADR-042 | ADR-018-arduinojson-data-interchange.md |
| ADR-019 | REST API Versioning Strategy | Accepted | - | - | ADR-019-rest-api-versioning-strategy.md |
| ADR-020 | Dallas DS18B20 Temperature Sensor Integration | Accepted | - | - | ADR-020-dallas-ds18b20-sensor-integration.md |
| ADR-021 | S0 Pulse Counter Hardware Interrupt Architecture | Accepted | - | - | ADR-021-s0-pulse-counter-interrupt-architecture.md |
| ADR-022 | GPIO Output Control (Bit-Flag Triggered Relays) | Accepted | - | - | ADR-022-gpio-output-bit-flag-control.md |
| ADR-023 | File System Explorer HTTP Architecture | Accepted | - | - | ADR-023-filesystem-explorer-http-api.md |
| ADR-024 | Debug Telnet Command Console | Accepted | - | - | ADR-024-debug-telnet-command-console.md |
| ADR-025 | Safari WebSocket Connection Management During Firmware Upload | Accepted | - | - | ADR-025-safari-websocket-connection-management.md |
| ADR-026 | Conditional JavaScript Cache-Busting for Firmware/Filesystem Version Mismatches | Superseded | - | Superseded by ADR-139 | ADR-026-conditional-javascript-cache-busting.md |
| ADR-027 | Version Mismatch Warning System in Web UI | Accepted | - | - | ADR-027-version-mismatch-warning-system.md |
| ADR-028 | File Streaming Over Loading for Memory Safety | Accepted | - | - | ADR-028-file-streaming-over-loading.md |
| ADR-029 | Simple XHR-Based OTA Flash (KISS Principle) | Accepted | - | - | ADR-029-simple-xhr-ota-flash.md |
| ADR-030 | Heap Memory Monitoring and Emergency Recovery | Accepted | - | - | ADR-030-heap-memory-monitoring-emergency-recovery.md |
| ADR-031 | Two-Microcontroller Coordination Architecture | Accepted | - | - | ADR-031-two-microcontroller-coordination-architecture.md |
| ADR-032 | No Authentication Pattern (Local Network Security Model) | Accepted | - | - | ADR-032-no-authentication-local-network-security.md |
| ADR-033 | Dallas Sensor Custom Labels and Graph Visualization | Accepted | - | - | ADR-033-dallas-sensor-custom-labels-graph-visualization.md |
| ADR-034 | Non-Blocking Modal Dialogs for User Input | Accepted | - | - | ADR-034-non-blocking-modal-dialogs.md |
| ADR-035 | RESTful API Compliance Strategy | Accepted | - | - | ADR-035-restful-api-compliance-strategy.md |
| ADR-036 | Boot Sequence Initialization Ordering | Accepted | - | - | ADR-036-boot-sequence-ordering.md |
| ADR-037 | Gateway Mode Detection via PR=M Polling | Accepted | - | - | ADR-037-gateway-mode-detection.md |
| ADR-038 | OpenTherm Message Data Flow Pipeline | Accepted | - | - | ADR-038-opentherm-data-flow-pipeline.md |
| ADR-039 | Real-Time OTGraph Charting Architecture | Accepted | - | - | ADR-039-otgraph-real-time-charting.md |
| ADR-040 | MQTT Source-Specific Topics for OpenTherm Values | Accepted | - | - | ADR-040-mqtt-source-specific-topics.md |
| ADR-041 | Just-In-Time Home Assistant MQTT Discovery | Accepted | - | - | ADR-041-jit-ha-discovery.md |
| ADR-042 | Streaming JSON I/O — No ArduinoJson | Superseded | - | Superseded by ADR-141; Supersedes ADR-018 | ADR-042-streaming-json-no-arduinojson.md |
| ADR-043 | Reset-Pattern WiFi Recovery Trigger | Accepted | - | - | ADR-043-reset-pattern-wifi-recovery.md |
| ADR-044 | Global State — extern Declaration in Header, Definition in .ino | Accepted | - | - | ADR-044-global-state-header-definition-pattern.md |
| ADR-045 | PS=1 Print Summary Parsing | Superseded | - | Superseded by ADR-046 | ADR-045-ps1-print-summary-parsing.md |
| ADR-046 | PS=1 Summary Translation with Shared Publish Helpers | Accepted | - | Supersedes ADR-045 | ADR-046-ps1-summary-translation-shared-publish-helpers.md |
| ADR-047 | Non-Blocking WiFi Reconnect State Machine | Superseded | - | Superseded by ADR-075 | ADR-047-nonblocking-wifi-reconnect.md |
| ADR-048 | Non-Blocking Webhook State Machine with Retry | Superseded | - | Superseded by ADR-136 | ADR-048-nonblocking-webhook-state-machine.md |
| ADR-049 | String Class Prohibition in Protocol Paths | Accepted | - | - | ADR-049-string-prohibition-protocol-paths.md |
| ADR-050 | Centralized API Route Dispatch Table | Accepted | - | - | ADR-050-centralized-api-route-dispatch.md |
| ADR-051 | Dual Encapsulating Structs (Settings + State) | Accepted | - | - | ADR-051-dual-encapsulating-structs.md |
| ADR-052 | MQTT Publish Eligibility and Reconnect Refresh Contract | Accepted | - | - | ADR-052-mqtt-publish-eligibility-contract.md |
| ADR-053 | Large Feature Buffer Static Allocation | Accepted | - | Supersedes ADR-004 | ADR-053-large-feature-buffer-static-allocation.md |
| ADR-054 | Optional HTTP Basic Authentication for Settings | Superseded | - | Superseded by ADR-056 | ADR-054-optional-http-basic-auth.md |
| ADR-055 | Webhook Outbound HTTP Integration | Superseded | - | Superseded by ADR-057 | ADR-055-webhook-outbound-http-integration.md |
| ADR-056 | Protected Admin Endpoint Security and Secret-Handling Contract | Accepted | - | Supersedes ADR-054 | ADR-056-protected-admin-endpoint-security-and-secret-handling-contract.md |
| ADR-057 | Webhook Delivery, Retry, and Protected Test Endpoint Policy | Accepted | - | Supersedes ADR-055 | ADR-057-webhook-delivery-retry-and-protected-test-endpoint-policy.md |
| ADR-058 | Non-blocking PIC Command/Response for PR= Queries | Accepted | - | - | ADR-058-nonblocking-pic-command-response.md |
| ADR-059 | Ser2net Queue Awareness and Serial Bus Coordination | Accepted | - | - | ADR-059-ser2net-queue-awareness.md |
| ADR-060 | PIC Availability Guard Pattern | Accepted | - | - | ADR-060-pic-availability-guard-pattern.md |
| ADR-061 | Unified ESP8266/ESP32 Platform Abstraction | Accepted | - | Supersedes ADR-001 | ADR-061-unified-esp8266-esp32-platform-abstraction.md |
| ADR-062 | — Retained discovery verification via wildcard subscribe with RAM-tuned buffer resize | Accepted | 2026-07-26 | - | ADR-062-retained-discovery-verification.md |
| ADR-063 | OTGW32 Hardware Support — Dual Build Targets with Runtime Feature Detection | Accepted | - | - | ADR-063-otgw32-hardware-support.md |
| ADR-064 | OT-Direct Operating Mode Architecture | Accepted | - | - | ADR-064-ot-direct-operating-mode-architecture.md |
| ADR-065 | — otgw-pic/ MQTT subtree as stable public topic API | Accepted | - | - | ADR-065-otgw-pic-mqtt-subtree.md |
| ADR-066 | Thermostat Auto-Detection and Master Mode | Accepted | - | - | ADR-066-thermostat-auto-detection-master-mode.md |
| ADR-067 | SSD1306Ascii Text-Only OLED Library | Accepted | - | - | ADR-067-ssd1306ascii-oled-library.md |
| ADR-068 | OT-Direct Schedule Tuning Constants | Accepted | - | - | ADR-068-ot-direct-schedule-tuning-constants.md |
| ADR-069 | SAT PID v3 Controller Implementation | Accepted | - | - | ADR-069-sat-pid-v3-implementation.md |
| ADR-070 | SAT Memory Allocation Strategy | Accepted | - | - | ADR-070-sat-memory-allocation-strategy.md |
| ADR-071 | SAT Heating Curve Algorithm | Accepted | - | - | ADR-071-sat-heating-curve-algorithm.md |
| ADR-072 | SAT Platform Compatibility Layer — ESP8266 vs. OTGW32 | Accepted | - | - | ADR-072-sat-platform-compatibility-layer.md |
| ADR-073 | SAT MQTT Topic Structure | Accepted | - | - | ADR-073-sat-mqtt-topic-structure.md |
| ADR-074 | ADR Audit — SAT Integration Phase | Accepted | - | - | ADR-074-adr-audit-sat-integration-phase.md |
| ADR-075 | WiFi Reconnect Timeout Tuning | Accepted | - | Supersedes ADR-047 | ADR-075-wifi-reconnect-timeout-tuning.md |
| ADR-076 | SAT OPV (Optimal Valve Position) Calibration | Accepted | - | - | ADR-076-sat-opv-calibration.md |
| ADR-077 | Streaming MQTT HA Discovery Architecture | Accepted | - | - | ADR-077-streaming-mqtt-ha-discovery-architecture.md |
| ADR-078 | MQTT Sub-command Dispatch Tables | Accepted | 2026-04-19 | - | ADR-078-mqtt-subcommand-dispatch-tables.md |
| ADR-079 | Per-component Type Headers (amendment to ADR-051) | Accepted | 2026-04-19 | - | ADR-079-per-component-state-settings-headers.md |
| ADR-080 | Binding ADR rules must have a CI gate | Accepted | 2026-04-19 | - | ADR-080-binding-adr-rules-must-have-a-ci-gate.md |
| ADR-081 | Types merge into `<Component>stuff.h` when both headers exist (amendment to ADR-079) | Accepted | 2026-04-19 | - | ADR-081-types-merge-into-stuff-when-both-exist.md |
| ADR-082 | ESP8266 Arduino Core 2.7.4 LTS pin for the 2.0.0 line | Superseded | 2026-06-12 | Superseded by ADR-128 | ADR-082-esp8266-arduino-core-2.7.4-lts-pin.md |
| ADR-083 | PlatformIO as primary build system for dual-target firmware | Accepted | 2026-04-24 | Supersedes ADR-014 | ADR-083-platformio-as-primary-build-system.md |
| ADR-084 | Generic OT-bus state MQTT topics (amends ADR-065) | Accepted | 2026-04-24 | - | ADR-084-generic-ot-bus-state-topics.md |
| ADR-085 | SAT (Smart Autotune Thermostat) Integration | Accepted | 2026-04-02 | - | ADR-085-sat-smart-autotune-thermostat-integration.md |
| ADR-086 | — Time-boundary consume-on-read helpers MUST have exactly one call site | Accepted | - | - | ADR-086-time-boundary-single-caller-contract.md |
| ADR-087 | Frame Bridge Pattern: Raw OT Frames to PIC-Format Text | Accepted | 2026-04-04 | - | ADR-087-frame-bridge-pattern.md |
| ADR-088 | MQTT Status Burst Windowing and Post-Burst Cooldown | Accepted | 2026-04-26 | - | ADR-088-mqtt-status-burst-windowing-and-cooldown.md |
| ADR-089 | Heap Tier Machine Contract | Superseded | 2026-07-31 | Superseded by ADR-167 | ADR-089-heap-tier-machine-contract.md |
| ADR-090 | Re-entrancy Guard Pattern for Shared Scratch Buffers | Accepted | 2026-04-26 | - | ADR-090-re-entrancy-guard-pattern-shared-scratch-buffers.md |
| ADR-091 | Design-System Class Drift Gated by evaluate.py | Accepted | 2026-04-28 | - | ADR-091-design-system-class-drift-gated-by-evaluate-py.md |
| ADR-092 | — Adopt NimBLE-Arduino over Bluedroid for SAT BLE Scanner | Accepted | 2026-04-30 | - | ADR-092-adopt-nimble-arduino-over-bluedroid-for-sat-ble-scanner.md |
| ADR-093 | Home Assistant Discovery Retained-Config Orphan Cleanup | Accepted | 2026-05-01 | - | ADR-093-ha-discovery-retained-config-orphan-cleanup.md |
| ADR-094 | Home Assistant discovery state reconciliation on OTA upgrade (feature-2.0.0 port of ADR-067) | Accepted | - | - | ADR-094-ha-discovery-state-reconciliation-on-ota-upgrade.md |
| ADR-095 | bSeparateSources Makes Base and Source-Variant Entities Mutually Exclusive (feature-2.0.0 port of ADR-068) | Superseded | 2026-05-07 | Superseded by ADR-119 | ADR-095-bseparatesources-mutually-exclusive-base-and-source-variants.md |
| ADR-096 | MQTT Source-Subtopic Worldview Semantics | Superseded | 2026-05-19 | Superseded by ADR-103 | ADR-096-mqtt-source-topic-worldview-semantics.md |
| ADR-097 | MQTT Publish Gating by Source and Per-MsgID Slave-Echo Classification | Accepted | 2026-05-27 | - | ADR-097-mqtt-publish-gating-by-source-and-slave-echo.md |
| ADR-098 | MQTT Discovery Topic Sibling-Suffix Shape (Supersedes ADR-097) | Accepted | 2026-05-07 | Supersedes ADR-119 | ADR-098-mqtt-discovery-topic-sibling-suffix-shape.md |
| ADR-099 | — HA Discovery Friendly-Name Format | Accepted | - | - | ADR-099-ha-discovery-friendly-name-format.md |
| ADR-100 | JIT HA Discovery with Smart Reconnect (Port of dev ADR-073) | Superseded | 2026-08-07 | Superseded by ADR-174 | ADR-100-jit-ha-discovery-smart-reconnect.md |
| ADR-101 | Flat Per-Value MQTT Topics Over Aggregated JSON Payloads | Accepted | 2026-05-08 | - | ADR-101-flat-per-value-mqtt-topics-over-aggregated-json-payloads.md |
| ADR-102 | HA Entity Availability Reflects the MQTT Link, Not OpenTherm-Bus Liveness (2.0.0) | Accepted | 2026-05-16 | - | ADR-102-ha-availability-reflects-mqtt-link-not-ot-bus.md |
| ADR-103 | MQTT Source-Topic Worldview Routing — Proxy-Answer (no-B) Refinement | Accepted | 2026-05-19 | Supersedes ADR-096 | ADR-103-mqtt-source-topic-proxy-answer-routing.md |
| ADR-104 | MQTT Status Fan-Out — Drop Global Rate-Gate, Keep Per-Slot Heartbeat (2.0.0) | Accepted | 2026-05-21 | - | ADR-104-mqtt-status-fanout-drop-global-rate-gate.md |
| ADR-105 | MQTT — Publish HA-Core-Style Self-Describing Aliases for Capability, State, Type, and Fault Bits under `settings.mqtt.bPublishHaCoreAliases` | Superseded | 2026-05-21 | Superseded by ADR-106 | ADR-105-mqtt-ha-core-capability-flag-aliases.md |
| ADR-106 | MQTT Topic Naming Mode — New Self-Describing Names by Default, Legacy OT-Spec Names via `settings.mqtt.bUseLegacyOtTopics` (Mutually Exclusive) | Accepted | 2026-05-21 | Supersedes ADR-105 | ADR-106-mqtt-topic-naming-mode-new-default-legacy-toggle.md |
| ADR-107 | Emergency Heap Recovery Actions (2.0.0 platform variant) | Accepted | 2026-05-23 | - | ADR-107-emergency-heap-recovery-actions.md |
| ADR-108 | MQTT connect() socket timeout accepted as known main-loop sync-blocker (2.0.0) | Superseded | 2026-06-14 | Superseded by ADR-131 | ADR-108-mqtt-connect-socket-timeout-as-accepted-sync-blocker.md |
| ADR-109 | — ESP32 REST response coalescing buffer | Superseded | 2026-06-14 | Superseded by ADR-132 | ADR-109-esp32-rest-response-coalescing-buffer.md |
| ADR-110 | sat-pv-surplus-setpoint-boost | Accepted | 2026-06-14 | - | ADR-110-sat-pv-surplus-setpoint-boost.md |
| ADR-111 | SAT MQTT publish — on-change + jittered heartbeat | Accepted | 2026-05-26 | - | ADR-111-sat-mqtt-publish-on-change-and-jittered-heartbeat.md |
| ADR-112 | Pure JIT MQTT Discovery (2.0.0 sibling of dev ADR-073) | Accepted | 2026-05-27 | - | ADR-112-pure-jit-mqtt-discovery.md |
| ADR-113 | Hardware-type as codepath-selection contract | Accepted | 2026-05-29 | - | ADR-113-hardware-type-codepath-selection-contract.md |
| ADR-114 | OLED runtime detection decoupled from the board flag | Accepted | 2026-06-02 | - | ADR-114-oled-runtime-detection-decoupled-from-board-flag.md |
| ADR-115 | Per-Board Numeric Constants and Typedefs Live in boards.h | Accepted | 2026-05-30 | - | ADR-115-per-board-constants-in-boards-h.md |
| ADR-116 | MQTT On-Change Publishing as the Default with One-Time Interval Migration | Accepted | 2026-05-31 | - | ADR-116-mqtt-on-change-publishing-default.md |
| ADR-117 | SAT Simulation Contract — Bus Isolation, Boiler-Absence Availability, Command Trace | Accepted | 2026-06-16 | - | ADR-117-sat-simulation-contract.md |
| ADR-118 | Surface gateway overrides as distinct override state | Accepted | 2026-06-01 | - | ADR-118-surface-gateway-overrides-as-distinct-override-state.md |
| ADR-119 | MQTT Source-Topic Sibling-Suffix Shape (feature-2.0.0 port of ADR-070; renumbered from ADR-097) | Superseded | 2026-05-07 | Superseded by ADR-098; Supersedes ADR-095 | ADR-119-mqtt-source-topic-sibling-suffix-shape.md |
| ADR-120 | Platform Abstraction Headers Promoted to the src/libraries/Platform Library | Accepted | 2026-06-02 | - | ADR-120-platform-abstraction-promoted-to-library.md |
| ADR-121 | Per-Consumer Heap Gating for the WebSocket Live-Log vs MQTT Publish | Superseded | 2026-07-31 | Superseded by ADR-167 | ADR-121-per-consumer-heap-gating-websocket-vs-mqtt.md |
| ADR-122 | HA Discovery Five-Device Topology | Superseded by adr-124 | 2026-06-05 | Superseded by ADR-124 | ADR-122-ha-discovery-five-device-topology.md |
| ADR-123 | 2.0.0 Concurrency Model — FreeRTOS PIC Task + Event-Driven Async Networking (ESP32-S3 only, ESP8266 dropped) | Accepted | 2026-06-12 | - | ADR-123-2-0-0-concurrency-model-async-modernization.md |
| ADR-124 | HA Discovery Seven-Device Topology — Dedicated OT-Core and Sensors Devices, Gateway via_device Hub | Accepted | 2026-06-06 | Superseded by ADR-140; Supersedes ADR-122 | ADR-124-ha-discovery-seven-device-topology.md |
| ADR-125 | Combo ESP32-S3 board: one binary, runtime PIC/OTDirect selection | Superseded | 2026-06-10 | Superseded by ADR-126 | ADR-125-combo-esp32-pic-otdirect-board-boot-detection.md |
| ADR-126 | Fixed esp32-classic build supersedes combo runtime detection | Superseded | 2026-06-12 | Superseded by ADR-127; Supersedes ADR-125 | ADR-126-fixed-esp32-classic-build-supersedes-combo-runtime-detection.md |
| ADR-127 | Combo ESP32-S3 single binary revived: runtime PIC/OTDirect boot detection (supersedes ADR-126) | Accepted | 2026-06-12 | Supersedes ADR-126 | ADR-127-combo-esp32-s3-single-binary-revived-runtime-boot-detection.md |
| ADR-128 | Drop ESP8266 Support from the 2.0.0 Line (Supersedes ADR-082) | Accepted | 2026-06-12 | Supersedes ADR-082 | ADR-128-drop-esp8266-support-from-2-0-0.md |
| ADR-129 | OT-Frame Queue and OTGWState Mutex Foundation (ADR-123 Phase 1) | Accepted | 2026-06-14 | - | ADR-129-ot-frame-queue-and-state-mutex-foundation.md |
| ADR-130 | PIC-UART Dedicated FreeRTOS Task as Sole OTGWSerial Owner (ADR-123 Phase 1) | Accepted | 2026-06-13 | - | ADR-130-pic-uart-dedicated-task-sole-serial-owner.md |
| ADR-131 | MQTT Engine on espMqttClient: Async Connect, Single Publish Chokepoint (ADR-123 Phase 2) | Accepted | 2026-06-14 | Supersedes ADR-108 | ADR-131-mqtt-engine-espmqttclient-async.md |
| ADR-132 | HTTP Stack on ESPAsyncWebServer with an Imperative-Push to Async-Pull Bridge (ADR-123 Phase 3) | Accepted | 2026-06-14 | Supersedes ADR-109 | ADR-132-async-web-server-and-imperative-push-bridge.md |
| ADR-133 | WebSocket Live-Log on AsyncWebSocket at /ws on Port 80 (ADR-123 Phase 3, supersedes ADR-005) | Accepted | 2026-06-14 | Supersedes ADR-005 | ADR-133-websocket-live-log-on-asyncwebsocket-port-80.md |
| ADR-134 | OTA Upload Handler on AsyncWebServer onUpload (ADR-123 Phase 3, closes the OTA seam ADR-132 opened) | Accepted | 2026-06-14 | - | ADR-134-async-ota-upload-handler-on-asyncwebserver.md |
| ADR-135 | ESP32 TWDT is the Primary Watchdog, External 0x26 Chip Demoted to Optional Secondary (Amends ADR-011) | Accepted | 2026-06-14 | - | ADR-135-twdt-primary-watchdog-external-0x26-optional-secondary.md |
| ADR-136 | Retire / Simplify the WiFi-Reconnect, Webhook, and PIC PR= State Machines (ADR-123 Phase 4) | Accepted | 2026-06-14 | Supersedes ADR-048 | ADR-136-retire-simplify-wifi-webhook-pic-state-machines.md |
| ADR-137 | Defer Outbound HTTP Initiated From an Async Handler to loop() Context (Amends ADR-132) | Accepted | 2026-06-14 | - | ADR-137-defer-outbound-http-from-async-handlers.md |
| ADR-138 | PIC-UART Control-Method Park Handshake, TX Requeue-to-Front Ordering, and Progress-Path Heap-Gate Decision (Amends ADR-130 and ADR-133) | Accepted | 2026-06-14 | - | ADR-138-pic-uart-control-method-park-and-tx-ordering.md |
| ADR-139 | ETag + Bounded max-age as the Project-Wide Cache-Busting Standard for Web UI Static Assets (Retire ?v= Query Versioning and the Chunked Index Rewriter); Align AsyncTCP Task Config with the EMS-ESP32 Blueprint | Accepted | 2026-06-15 | Supersedes ADR-026 | ADR-139-etag-cache-busting-standard-and-asynctcp-task-config.md |
| ADR-140 | Single-Device HA Discovery Topology with Source-Prefix Entity Clustering in One Device (align 2.0.0 with the 1.6.x single-device model) | Accepted | 2026-06-15 | Supersedes ADR-124 | ADR-140-single-device-ha-topology-entity-category-clustering.md |
| ADR-141 | Adopt ArduinoJson v7 for JSON on the ESP32-S3 2.0.0 line | Accepted | 2026-06-15 | Superseded by ADR-146; Supersedes ADR-042 | ADR-141-adopt-arduinojson-v7-esp32s3.md |
| ADR-142 | HA Discovery — Mark Unsupported MsgID Entities Unavailable via Availability List | Rejected | 2026-08-25 | - | ADR-142-ha-discovery-mark-unavailable-unsupported-msgids.md |
| ADR-143 | Telnet + ser2net transport on AsyncTCP (AsyncSimpleTelnet) to remove loop-task socket-write blocking | Accepted | 2026-06-17 | - | ADR-143-async-telnet-ser2net-transport-asynctcp.md |
| ADR-144 | Move the AsyncTCP service task to core 0 (amend ADR-139's core-1 pin); fix the under-load IDF Task-Watchdog reboot | Rejected | 2026-06-18 | - | ADR-144-asynctcp-task-core-affinity-move-to-core-0.md |
| ADR-145 | Serve REST JSON via a chunked, pull-based response that re-serializes per TCP window (no whole-response buffer) | Superseded | 2026-06-18 | Superseded by ADR-146 | ADR-145-chunked-pull-json-response-streaming.md |
| ADR-146 | Revert ADR-141: remove ArduinoJson, return to a hand-rolled streaming JSON writer (JsonEmit) on the ESP32-S3 REST path | Accepted | 2026-06-19 | Supersedes ADR-141, ADR-145 | ADR-146-revert-adr141-streaming-jsonemit-rest-esp32s3.md |
| ADR-147 | ESP32-S3 platform limits for concurrent webui static-file serving: keep LittleFS, guard the file-serve path, adopt the AsyncTCP config block (TASK-879) | Accepted | 2026-06-19 | - | ADR-147-esp32s3-platform-limits-concurrent-webui-static-serving.md |
| ADR-148 | BLE Sensors as Separate Home Assistant Child Devices via via_device (amend ADR-140's single-device rule for BLE probes only) | Accepted | 2026-06-20 | - | ADR-148-ble-sensors-as-ha-child-devices-via-device.md |
| ADR-149 | Accept the LWIP TCP-pcb connection ceiling on the ESP32-S3: keep the app-level connection mitigations, do not raise CONFIG_LWIP_MAX_ACTIVE_TCP (TASK-884) | Accepted | 2026-06-20 | - | ADR-149-accept-lwip-tcp-pcb-connection-ceiling-esp32s3.md |
| ADR-150 | SAT Per-Heating-System COLD_SETPOINT (Active Boiler-Off Cutoff on Low Demand) | Accepted | 2026-06-24 | - | ADR-150-sat-per-heating-system-cold-setpoint-boiler-off-cutoff.md |
| ADR-151 | — BLE Name Capture Stays on the Passive-Continuous Scan (Active-Scan Burst Rejected) | Accepted | 2026-06-22 | - | ADR-151-ble-hybrid-passive-continuous-with-on-demand-active-burst.md |
| ADR-152 | Coexisting v2 Web UI selected by a device-wide setting | Accepted | 2026-06-24 | - | ADR-152-coexisting-v2-web-ui-device-wide-default-setting.md |
| ADR-153 | — SAT BLE Adds Plaintext Xiaomi MiBeacon (0xFE95); Encrypted MiBeacon Deferred to a Gated Phase 2 | Accepted | 2026-07-04 | - | ADR-153-sat-ble-mibeacon-plaintext-defer-encrypted.md |
| ADR-154 | — Encrypted Xiaomi MiBeacon (v4/v5) via mbedtls AES-CCM with Per-Roster-Slot Bindkey Secret Storage | Accepted | 2026-07-04 | - | ADR-154-mibeacon-encrypted-aesccm-per-slot-bindkey.md |
| ADR-155 | v2 Web UI Connectivity Model — Two-Link OT Bus, MODE Separated from HEALTH, Five-State Vocabulary | Accepted | 2026-06-26 | - | ADR-155-v2-webui-connectivity-two-link-ot-bus.md |
| ADR-156 | Unified Off/Heat/Cool Home Assistant Climate Entity Derived from OpenTherm Status Bits | Accepted | 2026-06-27 | - | ADR-156-ha-climate-heat-cool-from-ot-status-bits.md |
| ADR-157 | SAT Heating-Source Selection Is Manual Configuration; Auto-Detect Is a Non-Control Hint | Accepted | 2026-06-29 | - | ADR-157-sat-heating-source-manual-config-auto-detect-is-non-control-hint.md |
| ADR-158 | Combo board: add the LOLIN S3 Mini Pro as a third boot-detected Classic variant | Accepted | 2026-06-29 | - | ADR-158-combo-s3-mini-pro-classic-variant-boot-detection.md |
| ADR-159 | Symmetric Presence-Gating of the External 0x26 Watchdog (Amends ADR-135) | Accepted | 2026-07-04 | - | ADR-159-symmetric-0x26-watchdog-presence-gating.md |
| ADR-160 | Combo board: AUTO hardware detection re-probes every boot and never persists its verdict | Superseded | 2026-07-04 | Superseded by ADR-164 | ADR-160-combo-auto-board-detect-per-boot-no-persist.md |
| ADR-161 | Dedicated REST Endpoint for the SAT BLE Sensor Roster with a Write-Only Per-Slot Secret | Accepted | 2026-07-04 | - | ADR-161-ble-roster-rest-endpoint-write-only-secret.md |
| ADR-162 | Sanctioned SAT Force-Boiler Test Hook in Production Firmware | Accepted | 2026-07-04 | - | ADR-162-sat-force-boiler-test-hook.md |
| ADR-163 | Web UI Static Assets Use Cache-Control: no-cache (Always-Revalidate via ETag); Amends ADR-139's Bounded max-age | Accepted | 2026-06-30 | - | ADR-163-web-asset-cache-control-no-cache-amends-adr139.md |
| ADR-164 | Combo AUTO board detection persists its PIC verdict once (supersedes ADR-160) | Accepted | 2026-07-04 | Supersedes ADR-160 | ADR-164-combo-auto-board-detect-persist-once-supersedes-adr160.md |
| ADR-165 | Optimal request parallelism on ESP32-S3 v2 Web UI/REST: N*=2 confirmed by two-phase load test (TASK-1015) | Accepted | 2026-07-06 | - | ADR-165-optimal-request-parallelism-esp32s3-webui-rest.md |
| ADR-166 | Single-app-slot boards: firmware/app OTA is USB-only, filesystem OTA stays on WiFi | Proposed | 2026-07-06 | - | ADR-166-single-app-slot-ota-policy.md |
| ADR-167 | Retire the ESP8266-Era Heap Tier Machine and Per-Consumer Gating on the ESP32-S3-Only Dev Branch | Accepted | 2026-07-31 | Supersedes ADR-089, ADR-121 | ADR-167-esp32s3-heap-tier-gating-removal-supersedes-adr089-adr121.md |
| ADR-168 | PIC Serial Link Binds Native UART0 on GPIO43/44; IDF Console Muted on the PIC Path | Proposed | 2026-07-09 | - | ADR-168-pic-serial-native-uart0-and-idf-console-mute.md |
| ADR-169 | PSRAM-Aware BLE Default with a No-PSRAM Instability-Consent Gate | Accepted | 2026-07-09 | - | ADR-169-psram-aware-ble-default-with-no-psram-consent-gate.md |
| ADR-170 | Unconditional Daily Drip Republish Replaces the Automatic Discovery-Verify Readback | Proposed | 2026-07-26 | - | ADR-170-daily-drip-republish-replaces-discovery-verify-readback.md |
| ADR-171 | Boot and Republish Discovery Queues Share One Non-OT ID Set | Proposed | 2026-07-26 | - | ADR-171-non-ot-discovery-single-source.md |
| ADR-172 | Rate-Limit the UI-Polled REST Endpoints with RFC 9457 429 Responses | Proposed | 2026-07-26 | - | ADR-172-rate-limit-ui-polled-rest-endpoints.md |
| ADR-173 | Client Poll Pacing, Locally-Ticked Device Clock, and 429 Re-Phasing | Proposed | 2026-07-26 | - | ADR-173-client-poll-pacing-local-clock-429-rephase.md |
| ADR-174 | Republish on-change gated MQTT state when Home Assistant comes back online | Accepted | 2026-08-07 | Supersedes ADR-100 | ADR-174-republish-on-change-gated-mqtt-state-when-home-assistant-comes-back-online.md |
| ADR-175 | Gate the OT coverage fixture on a lossless evidence source | Proposed | 2026-08-09 | - | ADR-175-gate-the-ot-coverage-fixture-on-a-lossless-evidence-source.md |
| ADR-176 | Publish a firmware-integrated cumulative DHW water total for the Home Assistant Energy dashboard | Accepted | 2026-08-25 | - | ADR-176-publish-a-firmware-integrated-cumulative-dhw-water-total-for-the-home-assistant-energy-dashboard.md |
| ADR-177 | Keep the PIC byte stream verbatim from the serial task to every consumer | Accepted | 2026-09-05 | - | ADR-177-keep-the-pic-byte-stream-verbatim-from-the-serial-task-to-every-consumer.md |
| ADR-178 | Widen the SAT area-sensor reference to accept a BLE MAC alongside a Dallas address | Proposed | 2026-09-22 | - | ADR-178-widen-the-sat-area-sensor-reference-to-accept-a-ble-mac-alongside-a-dallas-address.md |
| ADR-179 | Name the owner of the OpenTherm control setpoint while SAT is enabled | Proposed | 2026-09-22 | - | ADR-179-name-the-owner-of-the-opentherm-control-setpoint-while-sat-is-enabled.md |
<!-- adr-kit-index:end -->
