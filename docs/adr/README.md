...
| ADR-089 | Run the ADR pre-commit judge declarative-only until the LLM pass is bounded | Proposed | 2026-08-09 | - | ADR-089-run-the-adr-pre-commit-judge-declarative-only-until-the-llm-pass-is-bounded.md |
<!-- adr-kit-index:end -->
