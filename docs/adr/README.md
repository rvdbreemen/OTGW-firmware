...
| ADR-092 | Keep a recovery route reachable when the HTTP heap gate refuses | Proposed | 2026-08-25 | - | ADR-092-keep-a-recovery-route-reachable-when-the-http-heap-gate-refuses.md |
<!-- adr-kit-index:end -->
