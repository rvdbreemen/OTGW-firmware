...
| ADR-090 | Publish a firmware-integrated cumulative DHW water total for the Home Assistant Energy dashboard | Accepted | 2026-08-25 | - | ADR-090-publish-a-firmware-integrated-cumulative-dhw-water-total-for-the-home-assistant-energy-dashboard.md |
...
| ADR-093 | Keep the cumulative DHW water total in RAM and announce it on first data | Proposed | 2026-08-26 | - | ADR-093-keep-the-cumulative-dhw-water-total-in-ram-and-announce-it-on-first-data.md |
<!-- adr-kit-index:end -->
