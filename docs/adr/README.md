...
| ADR-011 | External Hardware Watchdog for Reliability | Accepted | - | - | ADR-011-external-hardware-watchdog.md |
...
| ADR-146 | Revert ADR-141: remove ArduinoJson, return to a hand-rolled streaming JSON writer (JsonEmit) on the ESP32-S3 REST path | Accepted | 2026-06-19 | Supersedes ADR-141 | ADR-146-revert-adr141-streaming-jsonemit-rest-esp32s3.md |
