...
| ADR-042 | Streaming JSON I/O — No ArduinoJson | Superseded | - | Superseded by ADR-141 | ADR-042-streaming-json-no-arduinojson.md |
...
| ADR-053 | Large Feature Buffer Static Allocation | Accepted | - | - | ADR-053-large-feature-buffer-static-allocation.md |
...
| ADR-056 | Protected Admin Endpoint Security and Secret-Handling Contract | Accepted | - | - | ADR-056-protected-admin-endpoint-security-and-secret-handling-contract.md |
...
| ADR-061 | Unified ESP8266/ESP32 Platform Abstraction | Accepted | - | - | ADR-061-unified-esp8266-esp32-platform-abstraction.md |
| ADR-062 | — Retained discovery verification via wildcard subscribe with RAM-tuned buffer resize | Accepted | 2026-07-26 | Superseded by ADR-170 | ADR-062-retained-discovery-verification.md |
...
| ADR-070 | SAT Memory Allocation Strategy | Accepted | - | Supersedes ADR-004 | ADR-070-sat-memory-allocation-strategy.md |
...
| ADR-075 | WiFi Reconnect Timeout Tuning | Accepted | - | - | ADR-075-wifi-reconnect-timeout-tuning.md |
...
| ADR-079 | Per-component Type Headers (amendment to ADR-051) | Accepted | 2026-04-19 | Supersedes ADR-051 | ADR-079-per-component-state-settings-headers.md |
...
| ADR-095 | bSeparateSources Makes Base and Source-Variant Entities Mutually Exclusive (feature-2.0.0 port of ADR-068) | Superseded | 2026-05-07 | Superseded by ADR-097 | ADR-095-bseparatesources-mutually-exclusive-base-and-source-variants.md |
...
| ADR-098 | MQTT Discovery Topic Sibling-Suffix Shape (Supersedes ADR-097) | Accepted | 2026-05-07 | Supersedes ADR-097 | ADR-098-mqtt-discovery-topic-sibling-suffix-shape.md |
...
| ADR-106 | MQTT Topic Naming Mode — New Self-Describing Names by Default, Legacy OT-Spec Names via `settings.mqtt.bUseLegacyOtTopics` (Mutually Exclusive) | Accepted | 2026-05-21 | Supersedes ADR-077 | ADR-106-mqtt-topic-naming-mode-new-default-legacy-toggle.md |
...
| ADR-123 | 2.0.0 Concurrency Model — FreeRTOS PIC Task + Event-Driven Async Networking (ESP32-S3 only, ESP8266 dropped) | Accepted | 2026-06-12 | Supersedes ADR-082 | ADR-123-2-0-0-concurrency-model-async-modernization.md |
...
| ADR-160 | Combo board: AUTO hardware detection re-probes every boot and never persists its verdict | Proposed | 2026-06-29 | - | ADR-160-combo-auto-board-detect-per-boot-no-persist.md |
...
| ADR-167 | Retire the ESP8266-Era Heap Tier Machine and Per-Consumer Gating on the ESP32-S3-Only Dev Branch | Accepted | 2026-07-31 | - | ADR-167-esp32s3-heap-tier-gating-removal-supersedes-adr089-adr121.md |
...
| ADR-170 | Unconditional Daily Drip Republish Replaces the Automatic Discovery-Verify Readback | Proposed | 2026-07-26 | Supersedes ADR-062 | ADR-170-daily-drip-republish-replaces-discovery-verify-readback.md |
...
| ADR-174 | Republish on-change gated MQTT state when Home Assistant comes back online | Accepted | 2026-08-07 | - | ADR-174-republish-on-change-gated-mqtt-state-when-home-assistant-comes-back-online.md |
