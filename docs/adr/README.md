...
| --- | --- | --- | --- | --- | --- |
| ADR-001 | ESP8266 Platform Selection | Proposed | - | - | ADR-001-esp8266-platform-selection.md |
| ADR-002 | Modular .ino File Architecture | Proposed | - | - | ADR-002-modular-ino-architecture.md |
| ADR-003 | HTTP-Only Network Architecture (No HTTPS) | Proposed | - | - | ADR-003-http-only-no-https.md |
| ADR-004 | Static Buffer Allocation Strategy | Proposed | - | - | ADR-004-static-buffer-allocation.md |
| ADR-005 | WebSocket for Real-Time Streaming | Proposed | - | - | ADR-005-websocket-real-time-streaming.md |
| ADR-006 | MQTT Integration Pattern | Proposed | - | - | ADR-006-mqtt-integration-pattern.md |
| ADR-007 | Timer-Based Task Scheduling | Proposed | - | - | ADR-007-timer-based-task-scheduling.md |
| ADR-008 | LittleFS for Configuration Persistence | Proposed | - | - | ADR-008-littlefs-configuration-persistence.md |
| ADR-009 | PROGMEM Usage for String Literals | Proposed | - | - | ADR-009-progmem-string-literals.md |
| ADR-010 | Multiple Concurrent Network Services | Proposed | - | - | ADR-010-multiple-concurrent-network-services.md |
| ADR-011 | External Hardware Watchdog for Reliability | Proposed | - | - | ADR-011-external-hardware-watchdog.md |
| ADR-012 | PIC Firmware Upgrade via Web UI | Proposed | - | - | ADR-012-pic-firmware-upgrade-via-web.md |
| ADR-013 | Arduino Framework Over ESP-IDF | Proposed | - | - | ADR-013-arduino-framework-over-esp-idf.md |
| ADR-014 | Dual Build System (Makefile + Python Script) | Proposed | - | - | ADR-014-dual-build-system.md |
| ADR-015 | NTP and AceTime for Time Management | Proposed | - | - | ADR-015-ntp-acetime-time-management.md |
| ADR-016 | OpenTherm Command Queue with Deduplication | Proposed | - | - | ADR-016-opentherm-command-queue.md |
| ADR-017 | WiFiManager for Initial Configuration | Proposed | - | - | ADR-017-wifimanager-initial-configuration.md |
| ADR-018 | ArduinoJson for Data Interchange | Proposed | - | - | ADR-018-arduinojson-data-interchange.md |
| ADR-019 | REST API Versioning Strategy | Proposed | - | - | ADR-019-rest-api-versioning-strategy.md |
| ADR-020 | Dallas DS18B20 Temperature Sensor Integration | Proposed | - | - | ADR-020-dallas-ds18b20-sensor-integration.md |
| ADR-021 | S0 Pulse Counter Hardware Interrupt Architecture | Proposed | - | - | ADR-021-s0-pulse-counter-interrupt-architecture.md |
| ADR-022 | GPIO Output Control (Bit-Flag Triggered Relays) | Proposed | - | - | ADR-022-gpio-output-bit-flag-control.md |
| ADR-023 | File System Explorer HTTP Architecture | Proposed | - | - | ADR-023-filesystem-explorer-http-api.md |
| ADR-024 | Debug Telnet Command Console | Proposed | - | - | ADR-024-debug-telnet-command-console.md |
| ADR-025 | Safari WebSocket Connection Management During Firmware Upload | Proposed | - | - | ADR-025-safari-websocket-connection-management.md |
| ADR-026 | Conditional JavaScript Cache-Busting for Firmware/Filesystem Version Mismatches | Proposed | - | - | ADR-026-conditional-javascript-cache-busting.md |
| ADR-027 | Version Mismatch Warning System in Web UI | Proposed | - | - | ADR-027-version-mismatch-warning-system.md |
| ADR-028 | File Streaming Over Loading for Memory Safety | Proposed | - | - | ADR-028-file-streaming-over-loading.md |
| ADR-029 | Simple XHR-Based OTA Flash (KISS Principle) | Proposed | - | - | ADR-029-simple-xhr-ota-flash.md |
| ADR-030 | Heap Memory Monitoring and Emergency Recovery | Proposed | - | - | ADR-030-heap-memory-monitoring-emergency-recovery.md |
| ADR-031 | Two-Microcontroller Coordination Architecture | Proposed | - | - | ADR-031-two-microcontroller-coordination-architecture.md |
| ADR-032 | No Authentication Pattern (Local Network Security Model) | Proposed | - | - | ADR-032-no-authentication-local-network-security.md |
...
| ADR-034 | Non-Blocking Modal Dialogs for User Input | Proposed | - | - | ADR-034-non-blocking-modal-dialogs.md |
| ADR-035 | RESTful API Compliance Strategy | Proposed | - | - | ADR-035-restful-api-compliance-strategy.md |
| ADR-036 | Boot Sequence Initialization Ordering | Proposed | - | - | ADR-036-boot-sequence-ordering.md |
| ADR-037 | Gateway Mode Detection via PR=M Polling | Proposed | - | - | ADR-037-gateway-mode-detection.md |
| ADR-038 | OpenTherm Message Data Flow Pipeline | Proposed | - | - | ADR-038-opentherm-data-flow-pipeline.md |
| ADR-039 | Real-Time OTGraph Charting Architecture | Proposed | - | - | ADR-039-otgraph-real-time-charting.md |
| ADR-040 | MQTT Source-Specific Topics for OpenTherm Values | Proposed | - | - | ADR-040-mqtt-source-specific-topics.md |
| ADR-041 | Just-In-Time Home Assistant MQTT Discovery | Proposed | - | - | ADR-041-jit-ha-discovery.md |
| ADR-042 | Streaming JSON I/O — No ArduinoJson | Proposed | - | - | ADR-042-streaming-json-no-arduinojson.md |
| ADR-043 | Reset-Pattern WiFi Recovery Trigger | Proposed | - | - | ADR-043-reset-pattern-wifi-recovery.md |
| ADR-044 | Global State — extern Declaration in Header, Definition in .ino | Proposed | - | - | ADR-044-global-state-header-definition-pattern.md |
| ADR-045 | PS=1 Print Summary Parsing | Proposed | - | - | ADR-045-ps1-print-summary-parsing.md |
| ADR-046 | PS=1 Summary Translation with Shared Publish Helpers | Proposed | - | Supersedes ADR-045 | ADR-046-ps1-summary-translation-shared-publish-helpers.md |
| ADR-047 | Non-Blocking WiFi Reconnect State Machine | Proposed | - | - | ADR-047-nonblocking-wifi-reconnect.md |
| ADR-048 | Non-Blocking Webhook State Machine with Retry | Proposed | - | - | ADR-048-nonblocking-webhook-state-machine.md |
| ADR-049 | String Class Prohibition in Protocol Paths | Proposed | - | - | ADR-049-string-prohibition-protocol-paths.md |
| ADR-050 | Centralized API Route Dispatch Table | Proposed | - | - | ADR-050-centralized-api-route-dispatch.md |
| ADR-051 | Dual Encapsulating Structs (Settings + State) | Proposed | - | - | ADR-051-dual-encapsulating-structs.md |
| ADR-052 | MQTT Publish Eligibility and Reconnect Refresh Contract | Proposed | - | - | ADR-052-mqtt-publish-eligibility-contract.md |
| ADR-053 | Large Feature Buffer Static Allocation | Proposed | - | - | ADR-053-large-feature-buffer-static-allocation.md |
| ADR-054 | Optional HTTP Basic Authentication for Settings | Proposed | - | - | ADR-054-optional-http-basic-auth.md |
| ADR-055 | Webhook Outbound HTTP Integration | Proposed | - | - | ADR-055-webhook-outbound-http-integration.md |
| ADR-056 | Protected Admin Endpoint Security and Secret-Handling Contract | Proposed | - | - | ADR-056-protected-admin-endpoint-security-and-secret-handling-contract.md |
| ADR-057 | Webhook Delivery, Retry, and Protected Test Endpoint Policy | Proposed | - | Supersedes ADR-055 | ADR-057-webhook-delivery-retry-and-protected-test-endpoint-policy.md |
| ADR-058 | Non-blocking PIC Command/Response for PR= Queries | Proposed | - | - | ADR-058-nonblocking-pic-command-response.md |
| ADR-059 | Ser2net Queue Awareness and Serial Bus Coordination | Proposed | - | - | ADR-059-ser2net-queue-awareness.md |
| ADR-060 | PIC Availability Guard Pattern | Proposed | - | - | ADR-060-pic-availability-guard-pattern.md |
| ADR-061 | Unified ESP8266/ESP32 Platform Abstraction | Proposed | - | - | ADR-061-unified-esp8266-esp32-platform-abstraction.md |
...
| ADR-063 | OTGW32 Hardware Support — Dual Build Targets with Runtime Feature Detection | Proposed | - | - | ADR-063-otgw32-hardware-support.md |
| ADR-064 | OT-Direct Operating Mode Architecture | Proposed | - | - | ADR-064-ot-direct-operating-mode-architecture.md |
| ADR-065 | — otgw-pic/ MQTT subtree as stable public topic API | Accepted | - | - | ADR-065-otgw-pic-mqtt-subtree.md |
| ADR-066 | Thermostat Auto-Detection and Master Mode | Proposed | - | - | ADR-066-thermostat-auto-detection-master-mode.md |
| ADR-067 | SSD1306Ascii Text-Only OLED Library | Proposed | - | - | ADR-067-ssd1306ascii-oled-library.md |
| ADR-068 | OT-Direct Schedule Tuning Constants | Proposed | - | - | ADR-068-ot-direct-schedule-tuning-constants.md |
| ADR-069 | SAT PID v3 Controller Implementation | Proposed | - | - | ADR-069-sat-pid-v3-implementation.md |
| ADR-070 | SAT Memory Allocation Strategy | Proposed | - | Supersedes ADR-004 | ADR-070-sat-memory-allocation-strategy.md |
| ADR-071 | SAT Heating Curve Algorithm | Proposed | - | - | ADR-071-sat-heating-curve-algorithm.md |
| ADR-072 | SAT Platform Compatibility Layer — ESP8266 vs. OTGW32 | Proposed | - | - | ADR-072-sat-platform-compatibility-layer.md |
| ADR-073 | SAT MQTT Topic Structure | Proposed | - | - | ADR-073-sat-mqtt-topic-structure.md |
| ADR-074 | ADR Audit — SAT Integration Phase | Proposed | - | - | ADR-074-adr-audit-sat-integration-phase.md |
| ADR-075 | WiFi Reconnect Timeout Tuning | Proposed | - | - | ADR-075-wifi-reconnect-timeout-tuning.md |
| ADR-076 | SAT OPV (Optimal Valve Position) Calibration | Proposed | - | - | ADR-076-sat-opv-calibration.md |
...
| ADR-176 | Publish a firmware-integrated cumulative DHW water total for the Home Assistant Energy dashboard | Proposed | 2026-08-24 | - | ADR-176-publish-a-firmware-integrated-cumulative-dhw-water-total-for-the-home-assistant-energy-dashboard.md |
<!-- adr-kit-index:end -->
