...
| ADR-083 | Per-Consumer Heap Gating (WebSocket vs MQTT decoupling) | Rejected | 2026-09-26 | - | ADR-083-per-consumer-heap-gating.md |
...
| ADR-097 | Allow two writers on port 25238 with a byte-transparent write floor | Accepted | 2026-09-26 | - | ADR-097-allow-two-writers-on-port-25238-with-a-byte-transparent-write-floor.md |
<!-- adr-kit-index:end -->
