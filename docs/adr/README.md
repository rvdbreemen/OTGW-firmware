...
| ADR-093 | Keep the cumulative DHW water total in RAM and announce it on first data | Accepted | 2026-08-26 | Supersedes ADR-090 | ADR-093-keep-the-cumulative-dhw-water-total-in-ram-and-announce-it-on-first-data.md |
| ADR-094 | Correct the DHW water total record: announce gating, live citations and measured costs | Proposed | 2026-08-26 | - | ADR-094-correct-the-dhw-water-total-record-announce-gating-live-citations-and-measured-costs.md |
<!-- adr-kit-index:end -->
