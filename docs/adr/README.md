...
| ADR-142 | HA Discovery — Mark Unsupported MsgID Entities Unavailable via Availability List | Deferred | 2026-07-09 | - | ADR-142-ha-discovery-mark-unavailable-unsupported-msgids.md |
