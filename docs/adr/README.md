...
| ADR-089 | Judge ADRs declaratively per commit and semantically once a week | Proposed | 2026-08-09 | - | ADR-089-judge-adrs-declaratively-per-commit-and-semantically-once-a-week.md |
| ADR-090 | Publish a firmware-integrated cumulative DHW water total for the Home Assistant Energy dashboard | Proposed | 2026-08-24 | - | ADR-090-publish-a-firmware-integrated-cumulative-dhw-water-total-for-the-home-assistant-energy-dashboard.md |
<!-- adr-kit-index:end -->
