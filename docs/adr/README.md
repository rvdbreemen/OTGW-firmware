...
| ADR-032 | No Authentication Pattern (Local Network Security Model) | Accepted | 2026-02-07 | Superseded by ADR-056 | ADR-032-no-authentication-local-network-security.md |
...
| ADR-042 | Streaming JSON I/O — No ArduinoJson | Accepted | 2026-02-28 | - | ADR-042-streaming-json-no-arduinojson.md |
...
| ADR-053 | Large Feature Buffer Static Allocation | Accepted | 2026-03-21 | - | ADR-053-large-feature-buffer-static-allocation.md |
...
| ADR-056 | Protected Admin Endpoint Security and Secret-Handling Contract | Accepted | 2026-03-21 | - | ADR-056-protected-admin-endpoint-security-and-secret-handling-contract.md |
...
| ADR-061 | WiFi Reconnect Timeout Tuning | Accepted | 2026-04-03 | - | ADR-061-wifi-reconnect-timeout-tuning.md |
...
| ADR-078 | Defer HA-Core Capability-Flag Aliases — Ship on 2.0.0 Only, Revert from `dev` | Accepted | 2026-05-21 | - | ADR-078-defer-ha-core-aliases-to-2-0-0-revert-from-dev.md |
...
| ADR-088 | Republish on-change gated MQTT state when Home Assistant comes back online | Accepted | 2026-08-07 | - | ADR-088-republish-on-change-gated-mqtt-state-when-home-assistant-comes-back-online.md |
