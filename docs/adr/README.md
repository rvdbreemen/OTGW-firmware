...
| ADR-177 | Keep the PIC byte stream verbatim from the serial task to every consumer | Proposed | 2026-09-05 | - | ADR-177-keep-the-pic-byte-stream-verbatim-from-the-serial-task-to-every-consumer.md |
<!-- adr-kit-index:end -->
