...
- TASK-641: Modbus TCP client for heat pump integration (ESP32-only, experimental). Uitgesteld vanuit v2.0.0 om launch-risico te beperken en de library-evaluatie zonder tijdsdruk uit te kunnen voeren.
