...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 sensor_max_value_age setting added (uint32_t seconds, default 21600)
- [ ] #2 error_monitoring bool setting added
- [ ] #3 automatic_gains_value float setting added (default 2.0)
- [ ] #4 heating_mode enum setting added (COMFORT/ECO)
- [ ] #5 cycles_per_hour int setting added (default 3, range 2-6)
- [ ] #6 climate_valve_offset float setting added (default 0, range -1 to 1)
- [ ] #7 solar_gain_freeze_integral bool setting added (default true)
- [ ] #8 All new settings persisted to flash via settingStuff.ino
- [ ] #9 All new settings have MQTT command topics
- [ ] #10 All new settings visible in REST API status JSON
