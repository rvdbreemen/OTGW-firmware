...
- [ ] #4 ADR-127 written and Accepted (supersedes ADR-126, root-cause evidence table, TASK-847 deferral documented); PINOUT.md updated
- [ ] #5 python build.py all 4 targets green; evaluate.py --quick green; ESP-abstraction baseline not raised
