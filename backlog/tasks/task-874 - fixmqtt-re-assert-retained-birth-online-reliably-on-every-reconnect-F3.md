...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 Birth 'online' is published reliably on every (re)connect (retry-until-queued or gate-bypass)
- [ ] #2 A dropped birth cannot strand HA availability at retained LWT offline (periodic re-assert OR guaranteed delivery)
