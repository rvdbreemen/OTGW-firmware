...
- [x] #6 Smoke test: WiFi boot on ESP8266 still works; OLED + Ethernet boot on ESP32 still works
<!-- AC:END -->
...
2026-04-28: User accepted the remaining hardware smoke verification for closure: ESP8266 WiFi boot and ESP32 OLED/Ethernet boot are considered working for this task.
<!-- SECTION:NOTES:END -->

## Final Summary

<!-- SECTION:FINAL_SUMMARY:BEGIN -->
Silenced the ESP8266 auto-prototype warning storm by applying the targeted ESP8266 build flag for unused static function prototypes generated by PlatformIO's ctags pass. ESP32 remains the platform where the affected code is compiled and checked. User accepted the remaining hardware smoke verification, so all ACs are closed.
