...
- [x] #9 minuteChanged call site stays at OTGW-firmware.ino:366 with ADR-086 comment anchor
- [x] #10 evaluate.py check_time_boundary_single_caller added: exactly 1 call site per helper
- [x] #11 ADR-086 accepted before merge
