...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 The 15 ADRs carry correct binding, gate, documents_shipped and verified_in derived from their own bodies, with the single-colon pointer form
- [ ] #2 Supersession edges match the resolved graph: false claims removed, 12 reciprocals present, partial supersessions kept in prose only
- [ ] #3 template.required_sections is set and completeness findings drop to 39
- [ ] #4 ADR-160 audit gate passes
- [ ] #5 Strict lint reports FAIL 63 and no ADR body line changed, verified by diff
<!-- AC:END -->
