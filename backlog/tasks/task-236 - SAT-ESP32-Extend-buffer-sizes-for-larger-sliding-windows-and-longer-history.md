...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 SAT_WIN4H_SIZE: 30 on ESP8266, 360 on ESP32 (12h of 2-min cycle history)
- [ ] #2 _hcr_dailyMedian: 7 days on ESP8266, 30 days on ESP32 (4-week heating curve trend)
- [ ] #3 _hcr_samples intra-day buffer: 96 on ESP8266, 1440 on ESP32 (per-minute sampling)
- [ ] #4 _flow_samples classifier: 64 on ESP8266, 256 on ESP32 (better p90/p10 accuracy)
- [ ] #5 All guards use #if defined(ESP8266) pattern, consistent with existing SAT_WIN4H_SIZE
- [ ] #6 ESP8266 build unaffected, ESP32 build verified
<!-- AC:END -->
