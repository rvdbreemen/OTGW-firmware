...
Triage 2026-05-22: superseded by TASK-626 (ADR-075 proxy-answer routing, commit 1ff0cdbb, shipped in beta.12 -> beta.16). The split-thermostat/boiler MQTT publication concern is now handled by the bAnswerOverride discriminator: proxy A -> _thermostat+_boiler+canonical; answer-override A -> _thermostat only. Closing.
<!-- SECTION:NOTES:END -->

## Final Summary

<!-- SECTION:FINAL_SUMMARY:BEGIN -->
Triaged 2026-05-22: work landed under TASK-626 (ADR-075 proxy-answer routing, dev commit 1ff0cdbb, shipped in beta.12+).
