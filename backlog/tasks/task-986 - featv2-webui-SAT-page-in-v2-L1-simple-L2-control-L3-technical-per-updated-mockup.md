...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 SAT nav entry + page with L1/L2/L3 layer picker matching updated mockup layout (history+minis in L2)
- [ ] #2 Header enable toggle and bench-simulation toggle use the sat-switch pattern and really read/write REST
- [ ] #3 L1 dial + presets bound to real sat/status; L2 tiles + history chart live; L3 diagnostics + raw JSON
