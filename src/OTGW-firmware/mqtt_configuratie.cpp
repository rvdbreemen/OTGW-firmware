...
const char ha_name_oemfaultcode[] PROGMEM = "OEMFaultCode";
...
const char ha_name_maxcapacityminmodlevel_hb_u8[] PROGMEM = "MaxCapacityMinModLevel_hb_u8";
const char ha_name_maxcapacityminmodlevel_lb_u8[] PROGMEM = "MaxCapacityMinModLevel_lb_u8";
...
const char ha_name_water_flow_rate_in_dhw_circuit[] PROGMEM = "Water_flow_rate_in_DHW circuit";
const char ha_name_water_flow_rate_in_dhw_circuit_2[] PROGMEM = "Water_flow_rate_in_DHW_circuit";
const char ha_name_daytime_dayofweek[] PROGMEM = "DayTime_dayofweek";
...
const char ha_name_flow_water_temperature_ch2_cir[] PROGMEM = "Flow_water_temperature_CH2 cir.";
...
const char ha_name_electricalcurrentburnerflame[] PROGMEM = "ElectricalCurrentBurnerFlame";
...
const char ha_name_tdhwsetubtdhwsetlb_value_hb[] PROGMEM = "TdhwSetUBTdhwSetLB_value_hb";
const char ha_name_tdhwsetubtdhwsetlb_value_lb[] PROGMEM = "TdhwSetUBTdhwSetLB_value_lb";
const char ha_name_maxtsetubmaxtsetlb_value_hb[] PROGMEM = "MaxTSetUBMaxTSetLB_value_hb";
const char ha_name_maxtsetubmaxtsetlb_value_lb[] PROGMEM = "MaxTSetUBMaxTSetLB_value_lb";
const char ha_name_hcratioubhcratiolb_value_hb[] PROGMEM = "HcratioUBHcratioLB_value_hb";
const char ha_name_hcratioubhcratiolb_value_lb[] PROGMEM = "HcratioUBHcratioLB_value_lb";
...
const char ha_name_controlsetpointvh_hb_u8[] PROGMEM = "ControlSetpointVH_hb_u8";
const char ha_name_controlsetpointvh_lb_u8[] PROGMEM = "ControlSetpointVH_lb_u8";
const char ha_name_asffaultcodevh_code[] PROGMEM = "ASFFaultCodeVH_code";
const char ha_name_asffaultcodevh_flag8[] PROGMEM = "ASFFaultCodeVH_flag8";
const char ha_name_diagnosticcodevh[] PROGMEM = "DiagnosticCodeVH";
const char ha_name_vh_configuration[] PROGMEM = "vh_configuration";
const char ha_name_vh_memberid_code[] PROGMEM = "vh_memberid_code";
const char ha_name_openthermversionvh[] PROGMEM = "OpenthermVersionVH";
const char ha_name_versiontypevh_hb_u8[] PROGMEM = "VersionTypeVH_hb_u8";
const char ha_name_versiontypevh_lb_u8[] PROGMEM = "VersionTypeVH_lb_u8";
const char ha_name_relative_ventilation[] PROGMEM = "Relative_Ventilation";
const char ha_name_relativeventilation_hb_u8[] PROGMEM = "RelativeVentilation_hb_u8";
const char ha_name_relativeventilation_lb_u8[] PROGMEM = "RelativeVentilation_lb_u8";
const char ha_name_relativeventilation[] PROGMEM = "RelativeVentilation";
const char ha_name_relative_humidity_exhaust_air[] PROGMEM = "Relative_Humidity_Exhaust_Air";
const char ha_name_relativehumidityexhaustair_hb_u8[] PROGMEM = "RelativeHumidityExhaustAir_hb_u8";
const char ha_name_relativehumidityexhaustair_lb_u8[] PROGMEM = "RelativeHumidityExhaustAir_lb_u8";
...
const char ha_name_supplyinlettemperature[] PROGMEM = "SupplyInletTemperature";
const char ha_name_supply_outlet_temperature[] PROGMEM = "Supply_Outlet_Temperature";
const char ha_name_supplyoutlettemperature[] PROGMEM = "SupplyOutletTemperature";
const char ha_name_exhaust_inlet_temperature[] PROGMEM = "Exhaust_Inlet_Temperature";
const char ha_name_exhaustinlettemperature[] PROGMEM = "ExhaustInletTemperature";
const char ha_name_exhaust_outlet_temperature[] PROGMEM = "Exhaust_Outlet_Temperature";
const char ha_name_exhaustoutlettemperature[] PROGMEM = "ExhaustOutletTemperature";
...
const char ha_name_remoteparametersettingvh_hb_flag8[] PROGMEM = "RemoteParameterSettingVH_hb_flag8";
const char ha_name_remoteparametersettingvh_lb_flag8[] PROGMEM = "RemoteParameterSettingVH_lb_flag8";
...
const char ha_name_nominalventilationvalue[] PROGMEM = "NominalVentilationValue";
const char ha_name_nominalventilationvalue_hb_u8[] PROGMEM = "NominalVentilationValue_hb_u8";
const char ha_name_nominalventilationvalue_lb_u8[] PROGMEM = "NominalVentilationValue_lb_u8";
const char ha_name_tspnumbervh_hb_u8[] PROGMEM = "TSPNumberVH_hb_u8";
const char ha_name_tspnumbervh_lb_u8[] PROGMEM = "TSPNumberVH_lb_u8";
const char ha_name_tspentryvh_hb_u8[] PROGMEM = "TSPEntryVH_hb_u8";
const char ha_name_tspentryvh_lb_u8[] PROGMEM = "TSPEntryVH_lb_u8";
const char ha_name_faultbuffersizevh_hb_u8[] PROGMEM = "FaultBufferSizeVH_hb_u8";
const char ha_name_faultbuffersizevh_lb_u8[] PROGMEM = "FaultBufferSizeVH_lb_u8";
const char ha_name_faultbufferentryvh_hb_u8[] PROGMEM = "FaultBufferEntryVH_hb_u8";
const char ha_name_faultbufferentryvh_lb_u8[] PROGMEM = "FaultBufferEntryVH_lb_u8";
const char ha_name_brand_hb_u8[] PROGMEM = "Brand_hb_u8";
const char ha_name_brand_lb_u8[] PROGMEM = "Brand_lb_u8";
const char ha_name_brandversion_hb_u8[] PROGMEM = "BrandVersion_hb_u8";
const char ha_name_brandversion_lb_u8[] PROGMEM = "BrandVersion_lb_u8";
const char ha_name_brandserialnumber_hb_u8[] PROGMEM = "BrandSerialNumber_hb_u8";
const char ha_name_brandserialnumber_lb_u8[] PROGMEM = "BrandSerialNumber_lb_u8";
const char ha_name_coolingoperationhours[] PROGMEM = "CoolingOperationHours";
const char ha_name_powercycles[] PROGMEM = "PowerCycles";
...
const char ha_name_operatingmode_hc1_hc2_dhw_hb_u8[] PROGMEM = "OperatingMode_HC1_HC2_DHW_hb_u8";
const char ha_name_operatingmode_hc1_hc2_dhw_lb_u8[] PROGMEM = "OperatingMode_HC1_HC2_DHW_lb_u8";
const char ha_name_remoteoverrideoperatingmode_dhw_mode[] PROGMEM = "RemoteOverrideOperatingMode_dhw_mode";
const char ha_name_remoteoverrideoperatingmode_dhw_mode_code[] PROGMEM = "RemoteOverrideOperatingMode_dhw_mode_code";
const char ha_name_remoteoverrideoperatingmode_hc1_mode[] PROGMEM = "RemoteOverrideOperatingMode_hc1_mode";
const char ha_name_remoteoverrideoperatingmode_hc1_mode_code[] PROGMEM = "RemoteOverrideOperatingMode_hc1_mode_code";
const char ha_name_remoteoverrideoperatingmode_hc2_mode[] PROGMEM = "RemoteOverrideOperatingMode_hc2_mode";
const char ha_name_remoteoverrideoperatingmode_hc2_mode_code[] PROGMEM = "RemoteOverrideOperatingMode_hc2_mode_code";
const char ha_name_remoteoverrideoperatingmode_manual_dhw_push[] PROGMEM = "RemoteOverrideOperatingMode_manual_dhw_push";
const char ha_name_roomremoteoverridefunction_flag8[] PROGMEM = "RoomRemoteOverrideFunction_flag8";
...
const char ha_name_solarstorageasfflags_code[] PROGMEM = "SolarStorageASFflags_code";
const char ha_name_solarstorageasfflags_flag8[] PROGMEM = "SolarStorageASFflags_flag8";
...
const char ha_name_solarstorageversiontype_hb_u8[] PROGMEM = "SolarStorageVersionType_hb_u8";
const char ha_name_solarstorageversiontype_lb_u8[] PROGMEM = "SolarStorageVersionType_lb_u8";
const char ha_name_solarstoragetsp_hb_u8[] PROGMEM = "SolarStorageTSP_hb_u8";
const char ha_name_solarstoragetsp_lb_u8[] PROGMEM = "SolarStorageTSP_lb_u8";
const char ha_name_solarstoragetspindextspvalue_hb_u8[] PROGMEM = "SolarStorageTSPindexTSPvalue_hb_u8";
const char ha_name_solarstoragetspindextspvalue_lb_u8[] PROGMEM = "SolarStorageTSPindexTSPvalue_lb_u8";
const char ha_name_solarstoragefhbsize_hb_u8[] PROGMEM = "SolarStorageFHBsize_hb_u8";
const char ha_name_solarstoragefhbsize_lb_u8[] PROGMEM = "SolarStorageFHBsize_lb_u8";
const char ha_name_solarstoragefhbindexfhbvalue_hb_u8[] PROGMEM = "SolarStorageFHBindexFHBvalue_hb_u8";
const char ha_name_solarstoragefhbindexfhbvalue_lb_u8[] PROGMEM = "SolarStorageFHBindexFHBvalue_lb_u8";
const char ha_name_electricityproducerstarts[] PROGMEM = "ElectricityProducerStarts";
const char ha_name_electricityproducerhours[] PROGMEM = "ElectricityProducerHours";
const char ha_name_electricityproduction[] PROGMEM = "ElectricityProduction";
const char ha_name_cumulativeelectricityproduction[] PROGMEM = "CumulativeElectricityProduction";
const char ha_name_burnerunsuccessfulstarts[] PROGMEM = "BurnerUnsuccessfulStarts";
const char ha_name_flamesignaltoolow[] PROGMEM = "FlameSignalTooLow";
const char ha_name_oemdiagnosticcode[] PROGMEM = "OEMDiagnosticCode";
const char ha_name_burnerstarts[] PROGMEM = "BurnerStarts";
const char ha_name_chpumpstarts[] PROGMEM = "CHPumpStarts";
const char ha_name_dhwpumpvalvestarts[] PROGMEM = "DHWPumpValveStarts";
const char ha_name_dhwburnerstarts[] PROGMEM = "DHWBurnerStarts";
const char ha_name_burneroperationhours[] PROGMEM = "BurnerOperationHours";
const char ha_name_chpumpoperationhoursg[] PROGMEM = "CHPumpOperationHoursg";
const char ha_name_chpumpoperationhours[] PROGMEM = "CHPumpOperationHours";
const char ha_name_dhwpumpvalveoperationhours[] PROGMEM = "DHWPumpValveOperationHours";
const char ha_name_dhwburneroperationhours_dhw[] PROGMEM = "DHWBurnerOperationHours DHW";
const char ha_name_dhwburneroperationhours[] PROGMEM = "DHWBurnerOperationHours";
...
const char ha_name_masterversion_hb_u8[] PROGMEM = "MasterVersion_hb_u8";
const char ha_name_masterversion_lb_u8[] PROGMEM = "MasterVersion_lb_u8";
const char ha_name_slaveversion_hb_u8[] PROGMEM = "SlaveVersion_hb_u8";
const char ha_name_slaveversion_lb_u8[] PROGMEM = "SlaveVersion_lb_u8";
...
const char ha_name_summerwintertime[] PROGMEM = "summerwintertime";
...
// ========== Climate and Number entries (handcrafted JSON) ==========
// climate -- OT ID 0
const char ha_climate_topic_0_climate[] PROGMEM =
    "%homeassistant%/climate/%node_id%/climate/config";
const char ha_climate_msg_0_climate[] PROGMEM =
    "{"
    ...
    "    \"sw_version\": \"%version%\""
    "  },"
    "  \"name\": \"%hostname%_Thermostat\","
    "  \"uniq_id\": \"%node_id%-thermostat\","
    "  \"curr_temp_t\": \"%mqtt_pub_topic%/Tr\","
    "  \"initial\": \"20\","
    "  \"max_temp\": \"28\","
    "  \"min_temp\": \"12\","
    "  \"mode_stat_tpl\": \"{% if value == 'ON' %}heat{% else %}off{% endif %}\","
    "  \"mode_stat_t\": \"%mqtt_pub_topic%/otgw-pic/thermostat_connected\","
    "  \"modes\": ["
    "    \"off\","
    "    \"heat\""
    "  ],"
    "  \"precision\": 0.1,"
    "  \"temp_cmd_t\": \"%mqtt_sub_topic%/command\","
    "  \"temp_cmd_tpl\": \"TT={{ value }}\","
    "  \"temp_stat_t\": \"%mqtt_pub_topic%/TrSet\","
    "  \"temp_unit\": \"C\","
    "  \"temp_step\": \"0.5\","
    "  \"payload_off\": 0,"
    "  \"payload_on\": 1"
...
// climate -- OT ID 0
const char ha_climate_topic_0_dhw_control[] PROGMEM =
    "%homeassistant%/climate/%node_id%/dhw_control/config";
const char ha_climate_msg_0_dhw_control[] PROGMEM =
    "{"
    "  \"action_template\": \"{% if value == 'ON' %}heating{% else %}idle{% endif %}\","
    "  \"action_topic\": \"%mqtt_pub_topic%/domestichotwater\","
    "  \"avty_t\": \"%mqtt_pub_topic%\","
    "  \"dev\": {"
    "    \"identifiers\": \"%node_id%\","
    "    \"manufacturer\": \"Schelte Bron\","
    ...
    "    \"sw_version\": \"%version%\""
    "  },"
    "  \"name\": \"%hostname%_DHW_Control\","
    "  \"uniq_id\": \"%node_id%-dhw_control\","
    "  \"optimistic\": true,"
    "  \"modes\": ["
    "    \"off\","
    "    \"auto\""
    "  ],"
    "  \"mode_stat_t\": \"%mqtt_pub_topic%/dhw_enable\","
    "  \"mode_stat_tpl\": \"{% if value == 'ON' %}auto{% else %}off{% endif %}\","
    "  \"curr_temp_t\": \"%mqtt_pub_topic%/Tdhw\","
    "  \"temp_stat_t\": \"%mqtt_pub_topic%/TdhwSet\","
    "  \"temp_cmd_t\": \"%mqtt_sub_topic%/command\","
    "  \"temp_cmd_tpl\": \"SW={{ value }}\","
    "  \"initial\": \"43\","
    "  \"min_temp\": \"40\","
    "  \"max_temp\": \"60\","
    "  \"temp_step\": \"1\","
...
// number -- OT ID 27
const char ha_number_topic_27_toutside_override[] PROGMEM =
    "%homeassistant%/number/%node_id%/Toutside_override/config";
const char ha_number_msg_27_toutside_override[] PROGMEM =
    "{"
    "  \"avty_t\": \"%mqtt_pub_topic%\","
    "  \"dev\": {"
    "    \"identifiers\": \"%node_id%\","
    ...
    "    \"sw_version\": \"%version%\""
    "  },"
    "  \"uniq_id\": \"%node_id%-Toutside_override\","
    "  \"device_class\": \"temperature\","
    "  \"name\": \"%hostname%_Outside_Temperature_Override\","
    "  \"cmd_t\": \"%mqtt_sub_topic%/outside\","
    "  \"stat_t\": \"%mqtt_pub_topic%/Toutside\","
...
const uint16_t MQTT_HA_SPECIAL_COUNT = 3;

const MqttHaSpecialCfg PROGMEM mqttHaSpecials[] = {
    {0, 0x08, HaEntityType::climate, ha_climate_topic_0_climate, ha_climate_msg_0_climate},
    {0, 0x00, HaEntityType::climate, ha_climate_topic_0_dhw_control, ha_climate_msg_0_dhw_control},
    {27, 0x00, HaEntityType::number, ha_number_topic_27_toutside_override, ha_number_msg_27_toutside_override},
};
