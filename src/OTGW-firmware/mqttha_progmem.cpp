...
const MqttHaCfgEntry PROGMEM mqttHaCfgTable[345] = {
  {0, 0, 0},  // [0] %homeassistant%/climate/%node_id%/climate/config
  {0, 49, 844},  // [1] %homeassistant%/climate/%node_id%/dhw_control/config
  {0, 102, 1662},  // [2] %homeassistant%/binary_sensor/%node_id%/fault/config
  {0, 155, 1947},  // [3] %homeassistant%/binary_sensor/%node_id%/centralheating/confi...
  {0, 217, 2260},  // [4] %homeassistant%/binary_sensor/%node_id%/domestichotwater/con...
  {0, 281, 2580},  // [5] %homeassistant%/binary_sensor/%node_id%/flame/config
  {0, 334, 2865},  // [6] %homeassistant%/binary_sensor/%node_id%/cooling/config
  {0, 389, 3156},  // [7] %homeassistant%/binary_sensor/%node_id%/centralheating2/conf...
  {0, 452, 3473},  // [8] %homeassistant%/binary_sensor/%node_id%/diagnostic_indicator...
  {0, 520, 3803},  // [9] %homeassistant%/binary_sensor/%node_id%/electric_production/...
  {0, 587, 4130},  // [10] %homeassistant%/binary_sensor/%node_id%/ch_enable/config
  {0, 644, 4440},  // [11] %homeassistant%/binary_sensor/%node_id%/dhw_enable/config
  {0, 702, 4755},  // [12] %homeassistant%/binary_sensor/%node_id%/cooling_enable/confi...
  {0, 764, 5067},  // [13] %homeassistant%/binary_sensor/%node_id%/otc_active/config
  {0, 822, 5367},  // [14] %homeassistant%/binary_sensor/%node_id%/ch2_enable/config
  {0, 880, 5681},  // [15] %homeassistant%/binary_sensor/%node_id%/thermostat_connected...
  {0, 948, 6021},  // [16] %homeassistant%/binary_sensor/%node_id%/boiler_connected/con...
  {0, 1012, 6349},  // [17] %homeassistant%/sensor/%node_id%/status_master/config
  {0, 1066, 6658},  // [18] %homeassistant%/sensor/%node_id%/status_slave/config
  {0, 1119, 6964},  // [19] %homeassistant%/binary_sensor/%node_id%/dhw_blocking/config
  {0, 1179, 7270},  // [20] %homeassistant%/binary_sensor/%node_id%/summerwintertime/con...
  {1, 1243, 7588},  // [21] %homeassistant%/sensor/%node_id%/TSet/config
  {1, 1288, 8008},  // [22] %homeassistant%/sensor/%node_id%/TSet/%source_topic_segment%...
  {2, 1356, 8478},  // [23] %homeassistant%/binary_sensor/%node_id%/master_configuration...
  {2, 1436, 8844},  // [24] %homeassistant%/sensor/%node_id%/master_configuration/config
  {2, 1497, 9181},  // [25] %homeassistant%/sensor/%node_id%/master_memberid_code/config
  {3, 1558, 9518},  // [26] %homeassistant%/binary_sensor/%node_id%/dhw_present/config
  {3, 1617, 9821},  // [27] %homeassistant%/binary_sensor/%node_id%/control_type_modulat...
  {3, 1688, 10160},  // [28] %homeassistant%/binary_sensor/%node_id%/cooling_config/confi...
  {3, 1750, 10473},  // [29] %homeassistant%/binary_sensor/%node_id%/dhw_config/config
  {3, 1808, 10773},  // [30] %homeassistant%/binary_sensor/%node_id%/master_low_off_pump_...
  {3, 1892, 11151},  // [31] %homeassistant%/binary_sensor/%node_id%/ch2_present/config
  {3, 1951, 11454},  // [32] %homeassistant%/binary_sensor/%node_id%/remote_water_filling...
  {3, 2028, 11811},  // [33] %homeassistant%/binary_sensor/%node_id%/heat_cool_mode_contr...
  {3, 2098, 12147},  // [34] %homeassistant%/sensor/%node_id%/slave_configuration/config
  {3, 2158, 12481},  // [35] %homeassistant%/sensor/%node_id%/slave_memberid_code/config
  {4, 2218, 12815},  // [36] %homeassistant%/sensor/%node_id%/Command_hb_u8/config
  {4, 2272, 13163},  // [37] %homeassistant%/sensor/%node_id%/Command_lb_u8/config
  {4, 2326, 13515},  // [38] %homeassistant%/sensor/%node_id%/Command_remote_command/conf...
  {5, 2389, 13876},  // [39] %homeassistant%/binary_sensor/%node_id%/service_request/conf...
  {5, 2452, 14191},  // [40] %homeassistant%/binary_sensor/%node_id%/lockout_reset/config
  {5, 2513, 14500},  // [41] %homeassistant%/binary_sensor/%node_id%/low_water_pressure/c...
  {5, 2579, 14821},  // [42] %homeassistant%/binary_sensor/%node_id%/gas_flame_fault/conf...
  {5, 2642, 15136},  // [43] %homeassistant%/binary_sensor/%node_id%/air_pressure_fault/c...
  {5, 2708, 15457},  // [44] %homeassistant%/binary_sensor/%node_id%/water_over_temperatu...
  {5, 2778, 15786},  // [45] %homeassistant%/sensor/%node_id%/ASF_flags/config
  {5, 2828, 16161},  // [46] %homeassistant%/sensor/%node_id%/OEMFaultCode/config
  {6, 2881, 16528},  // [47] %homeassistant%/binary_sensor/%node_id%/rbp_dhw_setpoint/con...
  {6, 2945, 16846},  // [48] %homeassistant%/binary_sensor/%node_id%/rbp_max_ch_setpoint/...
  {6, 3012, 17173},  // [49] %homeassistant%/binary_sensor/%node_id%/rbp_rw_dhw_setpoint/...
  {6, 3079, 17500},  // [50] %homeassistant%/binary_sensor/%node_id%/rbp_rw_max_ch_setpoi...
  {6, 3149, 17837},  // [51] %homeassistant%/sensor/%node_id%/RBP_flags_read_write/config
  {6, 3210, 18200},  // [52] %homeassistant%/sensor/%node_id%/RBP_flags_transfer_enable/c...
  {7, 3276, 18578},  // [53] %homeassistant%/sensor/%node_id%/CoolingControl/config
  {7, 3331, 18991},  // [54] %homeassistant%/sensor/%node_id%/CoolingControl/%source_topi...
  {8, 3409, 19454},  // [55] %homeassistant%/sensor/%node_id%/TsetCH2/config
  {8, 3457, 19882},  // [56] %homeassistant%/sensor/%node_id%/TsetCH2/%source_topic_segme...
  {9, 3528, 20360},  // [57] %homeassistant%/sensor/%node_id%/TrOverride/config
  {9, 3579, 20805},  // [58] %homeassistant%/sensor/%node_id%/TrOverride/%source_topic_se...
  {10, 3653, 21300},  // [59] %homeassistant%/sensor/%node_id%/TSP_hb_u8/config
  {10, 3703, 21630},  // [60] %homeassistant%/sensor/%node_id%/TSP_lb_u8/config
  {11, 3753, 21960},  // [61] %homeassistant%/sensor/%node_id%/TSPindexTSPvalue_hb_u8/conf...
  {11, 3816, 22322},  // [62] %homeassistant%/sensor/%node_id%/TSPindexTSPvalue_lb_u8/conf...
  {12, 3879, 22684},  // [63] %homeassistant%/sensor/%node_id%/FHBsize_hb_u8/config
  {12, 3933, 23038},  // [64] %homeassistant%/sensor/%node_id%/FHBsize_lb_u8/config
  {13, 3987, 23391},  // [65] %homeassistant%/sensor/%node_id%/FHBindexFHBvalue_hb_u8/conf...
  {13, 4050, 23757},  // [66] %homeassistant%/sensor/%node_id%/FHBindexFHBvalue_lb_u8/conf...
  {14, 4113, 24123},  // [67] %homeassistant%/sensor/%node_id%/MaxRelModLevelSetting/confi...
  {14, 4175, 24560},  // [68] %homeassistant%/sensor/%node_id%/MaxRelModLevelSetting/%sour...
  {15, 4260, 25047},  // [69] %homeassistant%/sensor/%node_id%/MaxCapacityMinModLevel_lb_u...
  {15, 4329, 25494},  // [70] %homeassistant%/sensor/%node_id%/MaxCapacityMinModLevel_hb_u...
  {16, 4398, 25935},  // [71] %homeassistant%/sensor/%node_id%/TrSet/config
  {16, 4444, 26354},  // [72] %homeassistant%/sensor/%node_id%/TrSet/%source_topic_segment...
  {17, 4513, 26823},  // [73] %homeassistant%/sensor/%node_id%/RelModLevel/config
  {17, 4565, 27233},  // [74] %homeassistant%/sensor/%node_id%/RelModLevel/%source_topic_s...
  {18, 4640, 27693},  // [75] %homeassistant%/sensor/%node_id%/CHPressure/config
  {18, 4691, 28106},  // [76] %homeassistant%/sensor/%node_id%/CHPressure/%source_topic_se...
  {19, 4765, 28597},  // [77] %homeassistant%/sensor/%node_id%/DHWFlowRate/config
  {19, 4817, 29016},  // [78] %homeassistant%/sensor/%node_id%/DHWFlowRate/%source_topic_s...
  {20, 4892, 29485},  // [79] %homeassistant%/sensor/%node_id%/DayTime_dayofweek/config
  {20, 4950, 29839},  // [80] %homeassistant%/sensor/%node_id%/DayTime_hour/config
  {20, 5003, 30178},  // [81] %homeassistant%/sensor/%node_id%/DayTime_minutes/config
  {21, 5059, 30526},  // [82] %homeassistant%/sensor/%node_id%/Date_day_of_month/config
  {21, 5117, 30880},  // [83] %homeassistant%/sensor/%node_id%/Date_month/config
  {22, 5168, 31213},  // [84] %homeassistant%/sensor/%node_id%/Year/config
  {22, 5213, 31528},  // [85] %homeassistant%/sensor/%node_id%/Year/%source_topic_segment%...
  {23, 5281, 31895},  // [86] %homeassistant%/sensor/%node_id%/TrSetCH2/config
  {23, 5330, 32322},  // [87] %homeassistant%/sensor/%node_id%/TrSetCH2/%source_topic_segm...
  {24, 5402, 32801},  // [88] %homeassistant%/sensor/%node_id%/Troom/config
  {24, 5448, 33220},  // [89] %homeassistant%/sensor/%node_id%/Tr/%source_topic_segment%/c...
  {25, 5514, 33686},  // [90] %homeassistant%/sensor/%node_id%/Tboiler/config
  {25, 5562, 34125},  // [91] %homeassistant%/sensor/%node_id%/Tboiler/%source_topic_segme...
  {26, 5633, 34614},  // [92] %homeassistant%/sensor/%node_id%/Tdhw/config
  {26, 5678, 35033},  // [93] %homeassistant%/sensor/%node_id%/Tdhw/%source_topic_segment%...
  {27, 5746, 35502},  // [94] %homeassistant%/sensor/%node_id%/Toutside/config
  {27, 5795, 35933},  // [95] %homeassistant%/number/%node_id%/Toutside_override/config
  {27, 5853, 36406},  // [96] %homeassistant%/sensor/%node_id%/Toutside/%source_topic_segm...
  {28, 5925, 36887},  // [97] %homeassistant%/sensor/%node_id%/Tret/config
  {28, 5970, 37315},  // [98] %homeassistant%/sensor/%node_id%/Tret/%source_topic_segment%...
  {29, 6038, 37793},  // [99] %homeassistant%/sensor/%node_id%/Tsolarstorage/config
  {29, 6092, 38240},  // [100] %homeassistant%/sensor/%node_id%/Tsolarstorage/%source_topic...
  {30, 6169, 38737},  // [101] %homeassistant%/sensor/%node_id%/Tsolarcollector/config
  {30, 6225, 39190},  // [102] %homeassistant%/sensor/%node_id%/Tsolarcollector/%source_top...
  {31, 6304, 39693},  // [103] %homeassistant%/sensor/%node_id%/TflowCH2/config
  {31, 6353, 40136},  // [104] %homeassistant%/sensor/%node_id%/TflowCH2/%source_topic_segm...
  {32, 6425, 40624},  // [105] %homeassistant%/sensor/%node_id%/Tdhw2/config
  {32, 6471, 41062},  // [106] %homeassistant%/sensor/%node_id%/Tdhw2/%source_topic_segment...
  {33, 6540, 41550},  // [107] %homeassistant%/sensor/%node_id%/Texhaust/config
  {33, 6589, 41988},  // [108] %homeassistant%/sensor/%node_id%/Texhaust/%source_topic_segm...
  {34, 6661, 42476},  // [109] %homeassistant%/sensor/%node_id%/Theatexchanger/config
  {34, 6716, 42924},  // [110] %homeassistant%/sensor/%node_id%/Theatexchanger/%source_topi...
  {35, 6794, 43424},  // [111] %homeassistant%/sensor/%node_id%/FanSpeed_setpoint_hz/config
  {35, 6855, 43847},  // [112] %homeassistant%/sensor/%node_id%/FanSpeed_actual_hz/config
  {36, 6914, 44266},  // [113] %homeassistant%/sensor/%node_id%/ElectricalCurrentBurnerFlam...
  {36, 6983, 44684},  // [114] %homeassistant%/sensor/%node_id%/ElectricalCurrentBurnerFlam...
  {37, 7075, 45153},  // [115] %homeassistant%/sensor/%node_id%/TRoomCH2/config
  {37, 7124, 45583},  // [116] %homeassistant%/sensor/%node_id%/TRoomCH2/%source_topic_segm...
  {38, 7196, 46065},  // [117] %homeassistant%/sensor/%node_id%/RelativeHumidity/config
  {38, 7253, 46477},  // [118] %homeassistant%/sensor/%node_id%/RelativeHumidity/%source_to...
  {39, 7333, 46939},  // [119] %homeassistant%/sensor/%node_id%/TrOverride2/config
  {39, 7385, 47383},  // [120] %homeassistant%/sensor/%node_id%/TrOverride2/%source_topic_s...
  {48, 7460, 47879},  // [121] %homeassistant%/sensor/%node_id%/TdhwSetUBTdhwSetLB_value_lb...
  {48, 7528, 48325},  // [122] %homeassistant%/sensor/%node_id%/TdhwSetUBTdhwSetLB_value_hb...
  {48, 7596, 48771},  // [123] %homeassistant%/sensor/%node_id%/TdhwSetUBTdhwSetLB_value_hb...
  {48, 7687, 49268},  // [124] %homeassistant%/sensor/%node_id%/TdhwSetUBTdhwSetLB_value_lb...
  {49, 7778, 49765},  // [125] %homeassistant%/sensor/%node_id%/MaxTSetUBMaxTSetLB_value_lb...
  {49, 7846, 50211},  // [126] %homeassistant%/sensor/%node_id%/MaxTSetUBMaxTSetLB_value_hb...
  {49, 7914, 50657},  // [127] %homeassistant%/sensor/%node_id%/MaxTSetUBMaxTSetLB_value_hb...
  {49, 8005, 51154},  // [128] %homeassistant%/sensor/%node_id%/MaxTSetUBMaxTSetLB_value_lb...
  {50, 8096, 51651},  // [129] %homeassistant%/sensor/%node_id%/HcratioUBHcratioLB_value_lb...
  {50, 8164, 52097},  // [130] %homeassistant%/sensor/%node_id%/HcratioUBHcratioLB_value_hb...
  {51, 8232, 52543},  // [131] %homeassistant%/sensor/%node_id%/Remoteparameter4boundaries_...
  {51, 8308, 52946},  // [132] %homeassistant%/sensor/%node_id%/Remoteparameter4boundaries_...
  {51, 8407, 53401},  // [133] %homeassistant%/sensor/%node_id%/Remoteparameter4boundaries_...
  {51, 8483, 53804},  // [134] %homeassistant%/sensor/%node_id%/Remoteparameter4boundaries_...
  {52, 8582, 54259},  // [135] %homeassistant%/sensor/%node_id%/Remoteparameter5boundaries_...
  {52, 8658, 54662},  // [136] %homeassistant%/sensor/%node_id%/Remoteparameter5boundaries_...
  {52, 8757, 55117},  // [137] %homeassistant%/sensor/%node_id%/Remoteparameter5boundaries_...
  {52, 8833, 55520},  // [138] %homeassistant%/sensor/%node_id%/Remoteparameter5boundaries_...
  {53, 8932, 55975},  // [139] %homeassistant%/sensor/%node_id%/Remoteparameter6boundaries_...
  {53, 9008, 56378},  // [140] %homeassistant%/sensor/%node_id%/Remoteparameter6boundaries_...
  {53, 9107, 56833},  // [141] %homeassistant%/sensor/%node_id%/Remoteparameter6boundaries_...
  {53, 9183, 57236},  // [142] %homeassistant%/sensor/%node_id%/Remoteparameter6boundaries_...
  {54, 9282, 57691},  // [143] %homeassistant%/sensor/%node_id%/Remoteparameter7boundaries_...
  {54, 9358, 58094},  // [144] %homeassistant%/sensor/%node_id%/Remoteparameter7boundaries_...
  {54, 9457, 58549},  // [145] %homeassistant%/sensor/%node_id%/Remoteparameter7boundaries_...
  {54, 9533, 58952},  // [146] %homeassistant%/sensor/%node_id%/Remoteparameter7boundaries_...
  {55, 9632, 59407},  // [147] %homeassistant%/sensor/%node_id%/Remoteparameter8boundaries_...
  {55, 9708, 59810},  // [148] %homeassistant%/sensor/%node_id%/Remoteparameter8boundaries_...
  {55, 9807, 60265},  // [149] %homeassistant%/sensor/%node_id%/Remoteparameter8boundaries_...
  {55, 9883, 60668},  // [150] %homeassistant%/sensor/%node_id%/Remoteparameter8boundaries_...
  {56, 9982, 61123},  // [151] %homeassistant%/sensor/%node_id%/TdhwSet/config
  {56, 10030, 61545},  // [152] %homeassistant%/sensor/%node_id%/TdhwSet/%source_topic_segme...
  {57, 10101, 62017},  // [153] %homeassistant%/sensor/%node_id%/MaxTSet/config
  {57, 10149, 62448},  // [154] %homeassistant%/sensor/%node_id%/MaxTSet/%source_topic_segme...
  {58, 10220, 62929},  // [155] %homeassistant%/sensor/%node_id%/Hcratio/config
  {58, 10268, 63359},  // [156] %homeassistant%/sensor/%node_id%/Hcratio/%source_topic_segme...
  {59, 10339, 63839},  // [157] %homeassistant%/sensor/%node_id%/Remoteparameter4/config
  {59, 10396, 64192},  // [158] %homeassistant%/sensor/%node_id%/Remoteparameter4/%source_to...
  {60, 10476, 64597},  // [159] %homeassistant%/sensor/%node_id%/Remoteparameter5/config
  {60, 10533, 64950},  // [160] %homeassistant%/sensor/%node_id%/Remoteparameter5/%source_to...
  {61, 10613, 65355},  // [161] %homeassistant%/sensor/%node_id%/Remoteparameter6/config
  {61, 10670, 65708},  // [162] %homeassistant%/sensor/%node_id%/Remoteparameter6/%source_to...
  {62, 10750, 66113},  // [163] %homeassistant%/sensor/%node_id%/Remoteparameter7/config
  {62, 10807, 66466},  // [164] %homeassistant%/sensor/%node_id%/Remoteparameter7/%source_to...
  {63, 10887, 66871},  // [165] %homeassistant%/sensor/%node_id%/Remoteparameter8/config
  {63, 10944, 67224},  // [166] %homeassistant%/sensor/%node_id%/Remoteparameter8/%source_to...
  {70, 11024, 67629},  // [167] %homeassistant%/binary_sensor/%node_id%/vh_ventilation_enabl...
  {70, 11094, 67965},  // [168] %homeassistant%/binary_sensor/%node_id%/vh_bypass_position/c...
  {70, 11160, 68289},  // [169] %homeassistant%/binary_sensor/%node_id%/vh_bypass_mode/confi...
  {70, 11222, 68601},  // [170] %homeassistant%/binary_sensor/%node_id%/vh_free_ventilation_...
  {70, 11294, 68943},  // [171] %homeassistant%/binary_sensor/%node_id%/vh_fault/config
  {70, 11350, 69237},  // [172] %homeassistant%/binary_sensor/%node_id%/vh_ventilation_mode/...
  {70, 11417, 69564},  // [173] %homeassistant%/binary_sensor/%node_id%/vh_bypass_status/con...
  {70, 11481, 69882},  // [174] %homeassistant%/binary_sensor/%node_id%/vh_bypass_automatic_...
  {70, 11555, 70230},  // [175] %homeassistant%/binary_sensor/%node_id%/vh_free_ventliation_...
  {70, 11629, 70578},  // [176] %homeassistant%/binary_sensor/%node_id%/vh_diagnostic_indica...
  {70, 11700, 70917},  // [177] %homeassistant%/sensor/%node_id%/status_vh_master/config
  {70, 11757, 71268},  // [178] %homeassistant%/sensor/%node_id%/status_vh_slave/config
  {71, 11813, 71616},  // [179] %homeassistant%/sensor/%node_id%/ControlSetpointVH/config
  {71, 11871, 72045},  // [180] %homeassistant%/sensor/%node_id%/ControlSetpointVH/%source_t...
  {71, 11952, 72524},  // [181] %homeassistant%/sensor/%node_id%/ControlSetpointVH_hb_u8/con...
  {71, 12016, 72896},  // [182] %homeassistant%/sensor/%node_id%/ControlSetpointVH_lb_u8/con...
  {71, 12080, 73268},  // [183] %homeassistant%/sensor/%node_id%/ControlSetpointVH_hb_u8/%so...
  {71, 12167, 73692},  // [184] %homeassistant%/sensor/%node_id%/ControlSetpointVH_lb_u8/%so...
  {72, 12254, 74116},  // [185] %homeassistant%/sensor/%node_id%/ASFFaultCodeVH_code/config
  {72, 12314, 74476},  // [186] %homeassistant%/sensor/%node_id%/ASFFaultCodeVH_flag8/config
  {73, 12375, 74839},  // [187] %homeassistant%/sensor/%node_id%/DiagnosticCodeVH/config
  {73, 12432, 75190},  // [188] %homeassistant%/sensor/%node_id%/DiagnosticCodeVH/%source_to...
  {74, 12512, 75593},  // [189] %homeassistant%/binary_sensor/%node_id%/vh_configuration_sys...
  {74, 12588, 75947},  // [190] %homeassistant%/binary_sensor/%node_id%/vh_configuration_byp...
  {74, 12659, 76286},  // [191] %homeassistant%/binary_sensor/%node_id%/vh_configuration_spe...
  {74, 12737, 76646},  // [192] %homeassistant%/sensor/%node_id%/vh_configuration/config
  {74, 12794, 76997},  // [193] %homeassistant%/sensor/%node_id%/vh_memberid_code/config
  {75, 12851, 77348},  // [194] %homeassistant%/sensor/%node_id%/OpenthermVersionVH/config
  {75, 12910, 77705},  // [195] %homeassistant%/sensor/%node_id%/OpenthermVersionVH/%source_...
  {76, 12992, 78114},  // [196] %homeassistant%/sensor/%node_id%/VersionTypeVH_hb_u8/config
  {76, 13052, 78474},  // [197] %homeassistant%/sensor/%node_id%/VersionTypeVH_lb_u8/config
  {77, 13112, 78834},  // [198] %homeassistant%/sensor/%node_id%/RelativeVentilation/config
  {77, 13172, 79253},  // [199] %homeassistant%/sensor/%node_id%/RelativeVentilation_hb_u8/c...
  {77, 13238, 79689},  // [200] %homeassistant%/sensor/%node_id%/RelativeVentilation_lb_u8/c...
  {77, 13304, 80125},  // [201] %homeassistant%/sensor/%node_id%/RelativeVentilation/%source...
  {77, 13387, 80595},  // [202] %homeassistant%/sensor/%node_id%/RelativeVentilation_hb_u8/%...
  {77, 13476, 81083},  // [203] %homeassistant%/sensor/%node_id%/RelativeVentilation_lb_u8/%...
  {78, 13565, 81571},  // [204] %homeassistant%/sensor/%node_id%/RelativeHumidityExhaustAir/...
  {78, 13632, 82041},  // [205] %homeassistant%/sensor/%node_id%/RelativeHumidityExhaustAir_...
  {78, 13705, 82526},  // [206] %homeassistant%/sensor/%node_id%/RelativeHumidityExhaustAir_...
  {78, 13778, 83011},  // [207] %homeassistant%/sensor/%node_id%/RelativeHumidityExhaustAir/...
  {78, 13868, 83533},  // [208] %homeassistant%/sensor/%node_id%/RelativeHumidityExhaustAir_...
  {78, 13964, 84070},  // [209] %homeassistant%/sensor/%node_id%/RelativeHumidityExhaustAir_...
  {79, 14060, 84607},  // [210] %homeassistant%/sensor/%node_id%/CO2LevelExhaustAir/config
  {79, 14119, 85061},  // [211] %homeassistant%/sensor/%node_id%/CO2LevelExhaustAir/%source_...
  {80, 14201, 85567},  // [212] %homeassistant%/sensor/%node_id%/SupplyInletTemperature/conf...
  {80, 14264, 86029},  // [213] %homeassistant%/sensor/%node_id%/SupplyInletTemperature/%sou...
  {81, 14350, 86541},  // [214] %homeassistant%/sensor/%node_id%/SupplyOutletTemperature/con...
  {81, 14414, 87006},  // [215] %homeassistant%/sensor/%node_id%/SupplyOutletTemperature/%so...
  {82, 14501, 87521},  // [216] %homeassistant%/sensor/%node_id%/ExhaustInletTemperature/con...
  {82, 14565, 87986},  // [217] %homeassistant%/sensor/%node_id%/ExhaustInletTemperature/%so...
  {83, 14652, 88501},  // [218] %homeassistant%/sensor/%node_id%/ExhaustOutletTemperature/co...
  {83, 14717, 88969},  // [219] %homeassistant%/sensor/%node_id%/ExhaustOutletTemperature/%s...
  {84, 14805, 89487},  // [220] %homeassistant%/sensor/%node_id%/ActualExhaustFanSpeed/confi...
  {84, 14867, 89909},  // [221] %homeassistant%/sensor/%node_id%/ActualExhaustFanSpeed/%sour...
  {85, 14952, 90383},  // [222] %homeassistant%/sensor/%node_id%/ActualSupplyFanSpeed/config
  {85, 15013, 90802},  // [223] %homeassistant%/sensor/%node_id%/ActualSupplyFanSpeed/%sourc...
  {86, 15097, 91273},  // [224] %homeassistant%/sensor/%node_id%/RemoteParameterSettingVH_hb...
  {86, 15171, 91675},  // [225] %homeassistant%/sensor/%node_id%/RemoteParameterSettingVH_lb...
  {86, 15245, 92077},  // [226] %homeassistant%/sensor/%node_id%/vh_rw_nominal_ventilation_v...
  {86, 15317, 92473},  // [227] %homeassistant%/sensor/%node_id%/vh_transfer_enable_nominal_...
  {87, 15402, 92908},  // [228] %homeassistant%/sensor/%node_id%/NominalVentilationValue/con...
  {87, 15466, 93280},  // [229] %homeassistant%/sensor/%node_id%/NominalVentilationValue_hb_...
  {87, 15536, 93670},  // [230] %homeassistant%/sensor/%node_id%/NominalVentilationValue_lb_...
  {87, 15606, 94060},  // [231] %homeassistant%/sensor/%node_id%/NominalVentilationValue/%so...
  {87, 15693, 94484},  // [232] %homeassistant%/sensor/%node_id%/NominalVentilationValue_hb_...
  {87, 15786, 94926},  // [233] %homeassistant%/sensor/%node_id%/NominalVentilationValue_lb_...
  {88, 15879, 95368},  // [234] %homeassistant%/sensor/%node_id%/TSPNumberVH_hb_u8/config
  {88, 15937, 95722},  // [235] %homeassistant%/sensor/%node_id%/TSPNumberVH_lb_u8/config
  {89, 15995, 96076},  // [236] %homeassistant%/sensor/%node_id%/TSPEntryVH_hb_u8/config
  {89, 16052, 96427},  // [237] %homeassistant%/sensor/%node_id%/TSPEntryVH_lb_u8/config
  {90, 16109, 96778},  // [238] %homeassistant%/sensor/%node_id%/FaultBufferSizeVH_hb_u8/con...
  {90, 16173, 97150},  // [239] %homeassistant%/sensor/%node_id%/FaultBufferSizeVH_lb_u8/con...
  {91, 16237, 97522},  // [240] %homeassistant%/sensor/%node_id%/FaultBufferEntryVH_hb_u8/co...
  {91, 16302, 97897},  // [241] %homeassistant%/sensor/%node_id%/FaultBufferEntryVH_lb_u8/co...
  {93, 16367, 98272},  // [242] %homeassistant%/sensor/%node_id%/Brand_hb_u8/config
  {93, 16419, 98608},  // [243] %homeassistant%/sensor/%node_id%/Brand_lb_u8/config
  {94, 16471, 98944},  // [244] %homeassistant%/sensor/%node_id%/BrandVersion_hb_u8/config
  {94, 16530, 99301},  // [245] %homeassistant%/sensor/%node_id%/BrandVersion_lb_u8/config
  {95, 16589, 99658},  // [246] %homeassistant%/sensor/%node_id%/BrandSerialNumber_hb_u8/con...
  {95, 16653, 100030},  // [247] %homeassistant%/sensor/%node_id%/BrandSerialNumber_lb_u8/con...
  {96, 16717, 100402},  // [248] %homeassistant%/sensor/%node_id%/CoolingOperationHours/confi...
  {96, 16779, 100831},  // [249] %homeassistant%/sensor/%node_id%/CoolingOperationHours/%sour...
  {97, 16864, 101312},  // [250] %homeassistant%/sensor/%node_id%/PowerCycles/config
  {97, 16916, 101710},  // [251] %homeassistant%/sensor/%node_id%/PowerCycles/%source_topic_s...
  {98, 16991, 102160},  // [252] %homeassistant%/sensor/%node_id%/RFSensorStatusInformation_b...
  {98, 17076, 102568},  // [253] %homeassistant%/sensor/%node_id%/RFSensorStatusInformation_b...
  {98, 17166, 102991},  // [254] %homeassistant%/sensor/%node_id%/RFSensorStatusInformation_s...
  {98, 17245, 103385},  // [255] %homeassistant%/sensor/%node_id%/RFSensorStatusInformation_s...
  {98, 17323, 103776},  // [256] %homeassistant%/sensor/%node_id%/RFSensorStatusInformation_s...
  {98, 17406, 104182},  // [257] %homeassistant%/sensor/%node_id%/RFSensorStatusInformation_s...
  {98, 17488, 104585},  // [258] %homeassistant%/sensor/%node_id%/RFSensorStatusInformation_s...
  {98, 17575, 105003},  // [259] %homeassistant%/sensor/%node_id%/RFstrengthbatterylevel_hb_u...
  {98, 17644, 105382},  // [260] %homeassistant%/sensor/%node_id%/RFstrengthbatterylevel_lb_u...
  {98, 17713, 105761},  // [261] %homeassistant%/sensor/%node_id%/RFstrengthbatterylevel_hb_u...
  {98, 17805, 106192},  // [262] %homeassistant%/sensor/%node_id%/RFstrengthbatterylevel_lb_u...
  {99, 17897, 106623},  // [263] %homeassistant%/sensor/%node_id%/OperatingMode_HC1_HC2_DHW_h...
  {99, 17969, 107019},  // [264] %homeassistant%/sensor/%node_id%/OperatingMode_HC1_HC2_DHW_l...
  {99, 18041, 107415},  // [265] %homeassistant%/sensor/%node_id%/RemoteOverrideOperatingMode...
  {99, 18118, 107826},  // [266] %homeassistant%/sensor/%node_id%/RemoteOverrideOperatingMode...
  {99, 18200, 108252},  // [267] %homeassistant%/sensor/%node_id%/RemoteOverrideOperatingMode...
  {99, 18277, 108663},  // [268] %homeassistant%/sensor/%node_id%/RemoteOverrideOperatingMode...
  {99, 18359, 109089},  // [269] %homeassistant%/sensor/%node_id%/RemoteOverrideOperatingMode...
  {99, 18436, 109500},  // [270] %homeassistant%/sensor/%node_id%/RemoteOverrideOperatingMode...
  {99, 18518, 109926},  // [271] %homeassistant%/sensor/%node_id%/RemoteOverrideOperatingMode...
  {99, 18602, 110358},  // [272] %homeassistant%/sensor/%node_id%/OperatingMode_HC1_HC2_DHW_h...
  {99, 18697, 110806},  // [273] %homeassistant%/sensor/%node_id%/OperatingMode_HC1_HC2_DHW_l...
  {100, 18792, 111254},  // [274] %homeassistant%/binary_sensor/%node_id%/remote_override_manu...
  {100, 18878, 111638},  // [275] %homeassistant%/binary_sensor/%node_id%/remote_override_prog...
  {100, 18965, 112025},  // [276] %homeassistant%/sensor/%node_id%/RoomRemoteOverrideFunction_...
  {101, 19038, 112424},  // [277] %homeassistant%/binary_sensor/%node_id%/solar_storage_slave_...
  {101, 19121, 112799},  // [278] %homeassistant%/sensor/%node_id%/solar_storage_master_mode/c...
  {101, 19187, 113205},  // [279] %homeassistant%/sensor/%node_id%/solar_storage_mode_status/c...
  {101, 19253, 113611},  // [280] %homeassistant%/sensor/%node_id%/solar_storage_slave_status/...
  {102, 19320, 114020},  // [281] %homeassistant%/sensor/%node_id%/SolarStorageASFflags_code/c...
  {102, 19386, 114398},  // [282] %homeassistant%/sensor/%node_id%/SolarStorageASFflags_flag8/...
  {103, 19453, 114779},  // [283] %homeassistant%/sensor/%node_id%/solar_storage_slave_configu...
  {103, 19527, 115181},  // [284] %homeassistant%/sensor/%node_id%/solar_storage_slave_memberi...
  {104, 19601, 115583},  // [285] %homeassistant%/sensor/%node_id%/SolarStorageVersionType_hb_...
  {104, 19671, 115973},  // [286] %homeassistant%/sensor/%node_id%/SolarStorageVersionType_lb_...
  {105, 19741, 116363},  // [287] %homeassistant%/sensor/%node_id%/SolarStorageTSP_hb_u8/confi...
  {105, 19803, 116729},  // [288] %homeassistant%/sensor/%node_id%/SolarStorageTSP_lb_u8/confi...
  {106, 19865, 117095},  // [289] %homeassistant%/sensor/%node_id%/SolarStorageTSPindexTSPvalu...
  {106, 19940, 117500},  // [290] %homeassistant%/sensor/%node_id%/SolarStorageTSPindexTSPvalu...
  {107, 20015, 117905},  // [291] %homeassistant%/sensor/%node_id%/SolarStorageFHBsize_hb_u8/c...
  {107, 20081, 118283},  // [292] %homeassistant%/sensor/%node_id%/SolarStorageFHBsize_lb_u8/c...
  {108, 20147, 118661},  // [293] %homeassistant%/sensor/%node_id%/SolarStorageFHBindexFHBvalu...
  {108, 20222, 119066},  // [294] %homeassistant%/sensor/%node_id%/SolarStorageFHBindexFHBvalu...
  {109, 20297, 119471},  // [295] %homeassistant%/sensor/%node_id%/ElectricityProducerStarts/c...
  {109, 20363, 119884},  // [296] %homeassistant%/sensor/%node_id%/ElectricityProducerStarts/%...
  {110, 20452, 120349},  // [297] %homeassistant%/sensor/%node_id%/ElectricityProducerHours/co...
  {110, 20517, 120787},  // [298] %homeassistant%/sensor/%node_id%/ElectricityProducerHours/%s...
  {111, 20605, 121277},  // [299] %homeassistant%/sensor/%node_id%/ElectricityProduction/confi...
  {111, 20667, 121726},  // [300] %homeassistant%/sensor/%node_id%/ElectricityProduction/%sour...
  {112, 20752, 122227},  // [301] %homeassistant%/sensor/%node_id%/CumulativeElectricityProduc...
  {112, 20824, 122714},  // [302] %homeassistant%/sensor/%node_id%/CumulativeElectricityProduc...
  {113, 20919, 123253},  // [303] %homeassistant%/binary_sensor/%node_id%/solar_storage_system...
  {113, 20992, 123598},  // [304] %homeassistant%/sensor/%node_id%/BurnerUnsuccessfulStarts/co...
  {113, 21057, 124037},  // [305] %homeassistant%/sensor/%node_id%/BurnerUnsuccessfulStarts/%s...
  {114, 21145, 124526},  // [306] %homeassistant%/sensor/%node_id%/FlameSignalTooLow/config
  {114, 21203, 124943},  // [307] %homeassistant%/sensor/%node_id%/FlameSignalTooLow/%source_t...
  {115, 21284, 125411},  // [308] %homeassistant%/sensor/%node_id%/OEMDiagnosticCode/config
  {115, 21342, 125793},  // [309] %homeassistant%/sensor/%node_id%/OEMDiagnosticCode/%source_t...
  {116, 21423, 126226},  // [310] %homeassistant%/sensor/%node_id%/BurnerStarts/config
  {116, 21476, 126629},  // [311] %homeassistant%/sensor/%node_id%/BurnerStarts/%source_topic_...
  {117, 21552, 127082},  // [312] %homeassistant%/sensor/%node_id%/CHPumpStarts/config
  {117, 21605, 127485},  // [313] %homeassistant%/sensor/%node_id%/CHPumpStarts/%source_topic_...
  {118, 21681, 127938},  // [314] %homeassistant%/sensor/%node_id%/DHWPumpValveStarts/config
  {118, 21740, 128359},  // [315] %homeassistant%/sensor/%node_id%/DHWPumpValveStarts/%source_...
  {119, 21822, 128830},  // [316] %homeassistant%/sensor/%node_id%/DHWBurnerStarts/config
  {119, 21878, 129242},  // [317] %homeassistant%/sensor/%node_id%/DHWBurnerStarts/%source_top...
  {120, 21957, 129704},  // [318] %homeassistant%/sensor/%node_id%/BurnerOperationHours/config
  {120, 22018, 130131},  // [319] %homeassistant%/sensor/%node_id%/BurnerOperationHours/%sourc...
  {121, 22102, 130608},  // [320] %homeassistant%/sensor/%node_id%/CHPumpOperationHours/config
  {121, 22163, 131036},  // [321] %homeassistant%/sensor/%node_id%/CHPumpOperationHours/%sourc...
  {122, 22247, 131513},  // [322] %homeassistant%/sensor/%node_id%/DHWPumpValveOperationHours/...
  {122, 22314, 131958},  // [323] %homeassistant%/sensor/%node_id%/DHWPumpValveOperationHours/...
  {123, 22404, 132453},  // [324] %homeassistant%/sensor/%node_id%/DHWBurnerOperationHours/con...
  {123, 22468, 132893},  // [325] %homeassistant%/sensor/%node_id%/DHWBurnerOperationHours/%so...
  {124, 22555, 133379},  // [326] %homeassistant%/sensor/%node_id%/OpenThermVersionMaster/conf...
  {124, 22618, 133780},  // [327] %homeassistant%/sensor/%node_id%/OpenThermVersionMaster/%sou...
  {125, 22704, 134232},  // [328] %homeassistant%/sensor/%node_id%/OpenThermVersionSlave/confi...
  {125, 22766, 134630},  // [329] %homeassistant%/sensor/%node_id%/OpenThermVersionSlave/%sour...
  {126, 22851, 135079},  // [330] %homeassistant%/sensor/%node_id%/MasterVersion_hb_u8/config
  {126, 22911, 135439},  // [331] %homeassistant%/sensor/%node_id%/MasterVersion_lb_u8/config
  {127, 22971, 135799},  // [332] %homeassistant%/sensor/%node_id%/SlaveVersion_hb_u8/config
  {127, 23030, 136156},  // [333] %homeassistant%/sensor/%node_id%/SlaveVersion_lb_u8/config
  {131, 23089, 136513},  // [334] %homeassistant%/sensor/%node_id%/RemehadFdUcodes_hb_u8/confi...
  {131, 23151, 136878},  // [335] %homeassistant%/sensor/%node_id%/RemehadFdUcodes_lb_u8/confi...
  {132, 23213, 137243},  // [336] %homeassistant%/sensor/%node_id%/RemehaServicemessage_hb_u8/...
  {132, 23280, 137623},  // [337] %homeassistant%/sensor/%node_id%/RemehaServicemessage_lb_u8/...
  {133, 23347, 138003},  // [338] %homeassistant%/sensor/%node_id%/RemehaDetectionConnectedSCU...
  {133, 23421, 138405},  // [339] %homeassistant%/sensor/%node_id%/RemehaDetectionConnectedSCU...
  {245, 23495, 138807},  // [340] %homeassistant%/sensor/%node_id%/s0pulsecount/config
  {245, 23548, 139176},  // [341] %homeassistant%/sensor/%node_id%/s0pulsecounttot/config
  {245, 23604, 139557},  // [342] %homeassistant%/sensor/%node_id%/s0pulsetime/config
  {245, 23656, 139925},  // [343] %homeassistant%/sensor/%node_id%/s0powerkw/config
  {246, 23706, 140340},  // [344] %homeassistant%/sensor/%node_id%/%sensor_id%/config
};
