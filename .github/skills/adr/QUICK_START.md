...
1. **[SKILL.md](.github/skills/adr/SKILL.md)** (23KB)
...
4. **[USAGE_GUIDE.md](.github/skills/adr/USAGE_GUIDE.md)** (15KB)
   - CI/CD integration examples
   - Troubleshooting guide
   - **Reference** when setting up automation

5. **[README.md](.github/skills/adr/README.md)** (4KB)
   - Quick overview
   - File descriptions
...
6. **[adr-compliance.yml.example](.github/workflows/adr-compliance.yml.example)** (8KB)
...
7. **[PULL_REQUEST_TEMPLATE.md.example](.github/PULL_REQUEST_TEMPLATE.md.example)** (4KB)
