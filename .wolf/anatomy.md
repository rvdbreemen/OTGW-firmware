...
> Auto-maintained by OpenWolf. Last scanned: 2026-06-20T06:56:13.229Z
...
- `raw-sessie-2026-06-20-otgw-task879-static-file-hang-fix.md` — Sessie-log 2026-06-20 (~1616 tok)

## ../../../Claude/Projects/Kluis/02-wiki/

- `espasyncwebserver-serving-idioom.md` — ESPAsyncWebServer serving-idioom (~2154 tok)
...
- `SKILL.md` — implement-next-task (~1394 tok)
...
- `feedback_one_async_branch.md` (~362 tok)
- `MEMORY.md` — OTGW-firmware Project Memory (~5855 tok)

## C:/Users/rvdbr/AppData/Local/Temp/

- `_provision_inject.py` — esc (~328 tok)
...
- `AsyncSimpleTelnet.h` — Declares uint8_t (~5409 tok)
